<!-- source-of-truth: package.json, src/config/rules.ts, src/data/cards/*.ts, src/data/starterDecks.ts, src/data/opponents.ts, src/scenes/, docs/rules.md, docs/ai.md, docs/roadmap.md, docs/release-notes/ · last-verified: 2026-09-21
...
That separation is what makes a real test suite possible: **3,817 tests across 251 files**, from engine rules and save migrations to the win-rate gates, in about fifteen minutes on the release-prep host.
