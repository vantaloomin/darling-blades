...
describe('Darlings replay v7', () => {
  ...
  it('preserves the v5 Darlings shape but refuses it through the v7 execution gate', () => {
  ...
  it('preserves the v4 Darlings reserve-only shape but refuses it through the v7 execution gate', () => {
