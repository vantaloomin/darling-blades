...
export const DB: CardDb = {
  ...
  tap_duty: { id: 'tap_duty', name: 'tap_duty', types: ['artifact'], subtypes: [], colors: [], rarity: 'c',
    cost: cost(1), activated: { cost: { tap: true, mana: cost(2) }, targets: [{ what: 'opponentCreature' }],
      ops: [{ op: 'tap', to: 'target' }] } },
  ping_duty: { id: 'ping_duty', name: 'ping_duty', types: ['artifact'], subtypes: [], colors: [], rarity: 'c',
    cost: cost(1), activated: { cost: { tap: true, mana: cost(1) }, ops: [{ op: 'damage', n: 1, to: 'opponent' }] } },
  zap_duty: { id: 'zap_duty', name: 'zap_duty', types: ['artifact'], subtypes: [], colors: [], rarity: 'c',
    cost: cost(1), activated: { cost: { tap: true, mana: cost(1) }, targets: [{ what: 'creature' }],
      ops: [{ op: 'damage', n: 2, to: 'target' }] } },
  kill_duty: { id: 'kill_duty', name: 'kill_duty', types: ['artifact'], subtypes: [], colors: [], rarity: 'c',
    cost: cost(1), activated: { cost: { tap: true, mana: cost(2) }, targets: [{ what: 'opponentCreature' }],
      ops: [{ op: 'destroy', to: 'target' }] } },
  preserve_bear: creature('preserve_bear', 2, 2, 2, { preserve: { cost: cost(2) } }),
  cost_link: { id: 'cost_link', name: 'cost_link', types: ['artifact'], subtypes: [], colors: [], rarity: 'c',
    cost: cost(2), hauntlink: { cost: cost(2), linked: { p: 1 } } },
