...
export const AVATARS: readonly Avatar[] = [
  ...
  // Rung 1 — Meng Huo: mono-G stompy midrange bruiser. (Easy)
  {
    ...
    darlingsDeck: [
      ...
      'cf-apple-of-emain',
      'gm-grave-rose-garden',
      'rg-alpha-of-the-hunt',
      'yn-old-growth-gridkeeper',
      'cf-moundlight-midwife',
      'yn-grow-the-grove',
      'so-stampede-season',
      'in-skysweeper-gale',
      'yn-rootcode-monk',
      'so-the-wilds-take-it-back',
      'in-valley-mist',
      ...
      'dt-briar-sentinel',
      'rg-wolf-pack-runner',
      'yn-concrete-forest-stalker',
      'gm-grave-soil-giant',
      'yn-jade-rain-brawler',
  ...
  // Rung 2 — Hestia: mono-W lifegain obsessive. (Easy)
  {
    ...
    darlingsDeck: [
      ...
      'tk-shu-machao',
      'ac-novice-squire',
      'yn-silk-rope-enforcer',
      'tk-other-yuanshao',
      'ar-terracotta-guardian',
      ...
      'tk-wei-xunyu',
      'tk-shu-liushan',
      'yn-halo-wire-priestess',
      'tk-wei-xuhuang',
      'rg-einherjar-champion',
      'rg-shu-deathless-guard',
  ...
  // Rung 10 — Brunhild: R/W Valkyrie double-strike aggro. (Hard · Ragnarök)
  {
    ...
    reserveDeck: expand([
      ...
      ['rg-ember-valkyrie', 4],
      ['rg-shieldwall-maiden', 4],
      ['yn-kitsune-neon-tyrant', 1],
      ['yn-queen-of-the-lanterned-roof', 1],
      ['ac-quest-for-the-grail', 1],
      ['gm-silver-bullet-duelist', 1],
      ['ac-round-table-vow', 1],
      ['cf-sidhe-silver-lancer', 1],
      ['yn-white-lantern-vanguard', 1],
      ['tk-wu-sunce', 1],
      ['rg-twice-chosen-shieldmaiden', 1],
      ['ac-camelot-banneret', 1],
    ]),
    landReserve: expand([
      ['land-mountain', 5],
      ['land-plains', 5],
  ...
  // Rung 15 — Carmilla: B/R dreaded vampire pressure. (Hard · Gothic Monsters)
  {
    ...
    reserveDeck: expand([
      ...
      ['ac-tournament-favorite', 1],
      ['cf-raven-torc-envoy', 1],
      ['ac-black-chapel-curse', 1],
      ['en-persephones-return', 1],
    ]),
    landReserve: expand([
      ['ld-burning-luoyang', 4],
      ['land-swamp', 3],
  ...
  // Rung 20 - Kitsune Neon Tyrant: U/R Hauntlink pressure. (Hard · Yokai Nights summit)
  {
    ...
    reserveDeck: expand([
      ...
      ['in-fire-attack', 4],
      ['in-undertow', 4],
      ['bk-harpy-skirmisher', 1],
      ['yn-network-sprite', 1],
      ['yn-ember-link-chain', 2],
      ['yn-burning-mask-of-the-void', 2],
      ['yn-blue-ghost-broadcaster', 1],
      ['tk-other-lubu', 1],
    ]),
    landReserve: expand([
      ['ld-red-cliffs-anchorage', 4],
