...
export const SANDS_OF_THE_DUAT = [
  ...
  },
  {
    ...
    cost: cost(1, 'R'),
    colors: ['R'],
    abilities: [{ when: 'spell', ops: [{ op: 'boost', p: 1, t: 0, keywords: ['warcry'], scope: 'allYours' }] }],
    rarity: 'c',
  ...
  },
  {
    ...
    cost: cost(1, 'R'),
    colors: ['R'],
    abilities: [{ when: 'spell', targets: [{ what: 'creature' }], ops: [{ op: 'boost', p: 3, t: 0, keywords: ['warcry'], scope: 'target' }] }],
    rarity: 'r',
