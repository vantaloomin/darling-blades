...
export const SANDS_OF_THE_DUAT = [
  ...
  },
  {
    ...
    cost: cost(1, 'R'),
    colors: ['R'],
    abilities: [{ when: 'dawn', ops: [{ op: 'damage', n: 1, to: 'opponent' }] }],
    rarity: 'r',
    ...
    abilities: [
      {
        when: 'dawn',
        ops: [
          { op: 'createToken', token: 'tok-duat-scarab', count: 2 },
          { op: 'grind', n: 2, who: 'self' },
        ],
      },
      { when: 'dies', ops: [{ op: 'severGrave', n: 2, who: 'opponent' }] },
    ],
    rarity: 'ur',
  ...
  },
  {
    ...
    defense: 5,
    keywords: ['sentinel'],
    abilities: [{ when: 'dawn', ops: [{ op: 'createToken', token: 'tok-bastet-kit', count: 1 }, { op: 'gainLife', n: 2 }] }],
    rarity: 'sr',
  ...
  },
  {
    ...
    defense: 6,
    keywords: ['sentinel'],
    abilities: [{ when: 'dawn', ops: [{ op: 'boost', p: 1, t: 1, scope: 'allYours' }, { op: 'gainLife', n: 3 }] }],
    rarity: 'ssr',
  ...
  },
  {
    ...
    abilities: [{ when: 'dawn', ops: [{ op: 'createToken', token: 'tok-bastet-kit', count: 2 }, { op: 'gainLife', n: 3 }] }],
    rarity: 'ur',
  ...
  },
  {
    ...
    cost: cost(0, 'UU'),
    colors: ['U'],
    abilities: [{ when: 'spell', ops: [{ op: 'foresee', n: 4 }, { op: 'draw', n: 1 }] }],
    rarity: 'ssr',
  ...
  },
  {
    ...
    defense: 6,
    abilities: [
      { when: 'arrives', ops: [{ op: 'grind', n: 2, who: 'self' }, { op: 'loseLife', n: 2, who: 'opponent' }] },
    ],
    preserve: { cost: cost(4, 'BB') },
    rarity: 'ssr',
  ...
  },
  {
    ...
    cost: cost(1, 'R'),
    colors: ['R'],
    abilities: [{ when: 'spell', targets: [{ what: 'creature' }], ops: [{ op: 'boost', p: 2, t: 2, keywords: ['warcry'], scope: 'target' }] }],
    rarity: 'r',
  ...
  },
  {
    ...
    cost: cost(2, 'G'),
    colors: ['G'],
    abilities: [{ when: 'spell', ops: [{ op: 'draw', n: 1 }, { op: 'extraLandDrop', n: 1 }] }],
    rarity: 'c',
  ...
  },
  {
    ...
    defense: 6,
    keywords: ['wardingGaze'],
    abilities: [{ when: 'arrives', ops: [{ op: 'extraLandDrop' }, { op: 'gainLife', n: 2 }] }],
    rarity: 'ssr',
