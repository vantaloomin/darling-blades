...
export const SANDS_OF_THE_DUAT = [
  ...
  },
  {
    ...
    cost: cost(3),
    colors: [],
    abilities: [{ when: 'dawn', ops: [{ op: 'severGrave', n: 1, who: 'opponent' }] }],
    rarity: 'r',
  ...
  },
  {
    ...
    keywords: ['bulwark'],
    abilities: [
      { when: 'static', static: { scope: 'filter', filter: { subtype: 'Construct' }, p: 1, t: 1 } },
  ...
  },
  {
    ...
    colors: ['W'],
    abilities: [
      { when: 'static', static: { scope: 'filter', filter: { subtype: 'Bastet' }, p: 1, t: 1 } },
  ...
  },
  {
    ...
    abilities: [{ when: 'dawn', ops: [{ op: 'createToken', token: 'tok-bastet-kit', count: 2 }, { op: 'gainLife', n: 4 }] }],
    rarity: 'ur',
  ...
  },
  {
    ...
    cost: cost(3, 'BB'),
    colors: ['B'],
    abilities: [{ when: 'spell', targets: [{ what: 'creature' }], ops: [{ op: 'destroy', to: 'target' }, { op: 'loseLife', n: 2, who: 'opponent' }] }],
    rarity: 'sr',
  ...
  },
  {
    ...
    cost: cost(2, 'R'),
    colors: ['R'],
    abilities: [{ when: 'spell', ops: [{ op: 'damage', n: 2, to: 'opponent' }] }],
    rarity: 'r',
  ...
  },
  {
    ...
    cost: cost(3, 'R'),
    colors: ['R'],
    abilities: [{ when: 'spell', targets: [{ what: 'any' }], ops: [{ op: 'damage', n: 4, to: 'target' }] }],
    rarity: 'r',
  ...
  },
  {
    ...
    cost: cost(1, 'R'),
    colors: ['R'],
    abilities: [{ when: 'spell', targets: [{ what: 'creature' }], ops: [{ op: 'boost', p: 2, t: 0, keywords: ['warcry'], scope: 'target' }] }],
    rarity: 'r',
  ...
  },
  {
    ...
    abilities: [{ when: 'spell', ops: [{ op: 'extraLandDrop', n: 2 }] }],
    rarity: 'c',
    flavor: 'She opens two channels before the sun reaches its height.',
  },
  {
  ...
  },
  {
    ...
    cost: cost(4, 'G'),
    colors: ['G'],
    abilities: [{ when: 'dawn', ops: [{ op: 'extraLandDrop' }] }],
    rarity: 'sr',
