...
export const RAGNAROK = [
  ...
  // --- Rune cycle (5) — carved runestone Auras ---
  {
    ...
    cost: cost(0, 'R'),
    colors: ['R'],
    abilities: [{ when: 'static', static: { scope: 'attached', p: 2, t: 0, grantKeywords: ['haste'] } }],
    rarity: 'c',
  ...
  },
  {
    ...
    cost: cost(1, 'G'),
    colors: ['G'],
    abilities: [{ when: 'static', static: { scope: 'attached', p: 2, t: 2, grantKeywords: ['trample'] } }],
    rarity: 'c',
  ...
  },
  {
    ...
    cost: cost(0, 'B'),
    colors: ['B'],
    abilities: [{ when: 'static', static: { scope: 'attached', p: 1, t: 1, grantKeywords: ['deathtouch'] } }],
    rarity: 'c',
  ...
  },
  {
    ...
    cost: cost(0, 'U'),
    colors: ['U'],
    abilities: [{ when: 'static', static: { scope: 'attached', p: 1, t: 1, grantKeywords: ['flying'] } }],
    rarity: 'c',
  ...
  },
  {
    ...
    cost: cost(1, 'W'),
    colors: ['W'],
    abilities: [{ when: 'static', static: { scope: 'attached', p: 1, t: 2, grantKeywords: ['vigilance'] } }],
    rarity: 'c',
    ...
    abilities: [
      {
        ...
        ops: [{ op: 'pump', p: 1, t: 0, keywords: ['doubleStrike'], scope: 'target' }],
      },
    ],
    rarity: 'c',
