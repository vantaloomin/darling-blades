...
export const RAGNAROK = [
  ...
  // =========================================================================
  {
    ...
    defense: 5,
    abilities: [
      { when: 'arrives', ops: [{ op: 'mill', n: 3, who: 'self' }, { op: 'reanimate', to: 'top' }] },
    ],
    rarity: 'ur',
  ...
  },
  {
    ...
    defense: 4,
    keywords: ['twinBlades'],
    abilities: [{ when: 'arrives', ops: [{ op: 'reanimate', to: 'top' }] }],
    rarity: 'ur',
  ...
  },
  {
    ...
    abilities: [
      ...
      { when: 'dawn', ops: [{ op: 'mill', n: 1, who: 'self' }, { op: 'draw', n: 1 }] },
    ],
    rarity: 'ssr',
  ...
  },
  {
    ...
    defense: 3,
    abilities: [
      { when: 'arrives', ops: [{ op: 'createToken', token: 'tok-wolf', count: 1 }] },
  ...
  },
  {
    ...
    attack: 2,
    defense: 3,
    abilities: [{ when: 'arrives', ops: [{ op: 'mill', n: 3, who: 'self' }, { op: 'draw', n: 1 }] }],
    rarity: 'sr',
  ...
  },
  {
    ...
    defense: 4,
    abilities: [
      { when: 'arrives', ops: [{ op: 'gainLife', n: 4 }] },
  ...
  // --- Blue (3) ---
  {
    ...
    attack: 2,
    defense: 3,
    abilities: [{ when: 'arrives', ops: [{ op: 'mill', n: 2, who: 'self' }, { op: 'draw', n: 1 }] }],
    rarity: 'r',
  ...
  // --- Black (4) ---
  {
    ...
    attack: 2,
    defense: 3,
    abilities: [{ when: 'arrives', ops: [{ op: 'mill', n: 3, who: 'self' }] }],
    rarity: 'r',
  ...
  },
  {
    ...
    attack: 2,
    defense: 2,
    abilities: [{ when: 'arrives', ops: [{ op: 'mill', n: 2, who: 'self' }] }],
    rarity: 'c',
