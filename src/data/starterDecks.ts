...
export const THEME_DECKS: DeckList[] = [
  ...
  },
  {
    ...
    reserveCards: expand([
      ...
      ['cf-blackthorn-duelist', 4],
      ['cf-silver-branch-oracle', 4],
      ['cf-moon-pool-selkie', 4],
      ['cf-hounds-of-annwn', 4],
      ['cf-raven-torc-envoy', 2],
      ['cf-glimmerdust-trick', 4],
  ...
  },
  {
    ...
    reserveCards: expand([
      ...
      ['ac-pennant-carrier', 4],
      ['ac-novice-squire', 4],
      ['ac-excalibur-from-lake', 3],
      ['ac-lion-standard', 1],
      ['ac-quest-for-the-grail', 2],
      ['ac-round-table-vow', 2],
      ['ac-squire-to-champion', 4],
      ['in-undertow', 4],
      ['in-shieldwall', 4],
    ]),
    landReserve: expand([
