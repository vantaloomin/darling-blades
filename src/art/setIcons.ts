...
export const SET_ICON_PATHS: Record<CardSetId, string> = {
  ...
  // The drowned bell (Drowned Deep, 2026-09-15): Dunmarrow's bell with the tide-line punched across it as one wave band, and the clapper hanging free below the lip.
  'drowned-deep':
