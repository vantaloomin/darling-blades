 ...
 * uncropped originals are kept in <tmp>/gen-spell-art/ for inspection.
 */
...
function main(): void {
  ...
  // Preflight the post-processor BEFORE burning any generation quota — a missing
  // Pillow would otherwise fail every entry after its paid call.
