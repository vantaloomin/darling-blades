...
const CARD_OVERRIDES: Record<string, Art> = {
  'ac-artoria-once-future': {
    ...
    costume: 'bright white-and-gold plate, a high but crop-safe royal crown, a white cloak, pearl gorget, and crimson oath sash',
    background: 'a sunlit Camelot keep above tournament grounds, chapel windows and blank crimson pennants opening behind her',
    props: 'an awakened enchanted sword held upright and a round steel shield carrying only abstract, non-lettered relief',
    pose: 'low-angle frontal three-quarter hero stance, sword rising beside the face and crown fully separated from the sky',
  ...
  'ac-lancelot-moonlit-shame': {
    kind: 'an adult genderbent Lancelot, elite knight whose moonlit shame rides beside her',
    costume: 'polished silver plate, a torn white cloak, crimson sash, dark under-armor, and a low thorned circlet',
    background: 'a moonlit tournament road beside a silent lake, blank pennants and a distant chapel behind',
    props: 'two distinct enchanted blades, one in each correctly gripping hand, with tears catching the light',
    pose: 'dynamic mounted or advancing three-quarter action, both blades crossing the middle band without fused grips',
    mood: 'brilliant, grieving, and carrying the shame no banner can hide',
  ...
  'ac-velvet-court-spy': {
    kind: 'an adult court spy rendered as a brightly lit ornate princess-knight, accepted as a deliberately weak stealth read',
    costume: 'ornate white-and-crimson princess gown over polished steel, jeweled thorn crown, velvet sleeves, and silver trim',
    background: 'a bright court hall with chapel windows, polished floors, and blank crimson pennants',
    props: 'floating translucent foresee panels with abstract light only, a concealed court blade, and a silver cup',
    pose: 'front three-quarter presentation, one hand arranging the floating panels while the other rests near the blade',
    mood: 'charming, radiant, and knowingly unstealthy; the public performance is the disguise',
  ...
  'ac-grail-hermit': {
    kind: 'an adult Grail Hermit whose approved art reads as an ornate paladin more than a ragged hermit',
    costume: 'ornate green-and-silver paladin plate beneath a rough white cloak, grail clasp, thorn circlet, and polished mantle',
    background: 'a green roadside chapel with bright grail light, a stone spring, and a distant keep',
    props: 'a covered grail, a plain staff, and a small unmarked bowl held close beneath the cloak',
    pose: 'three-quarter paladin portrait with the grail revealed from the rough cloak and the face held clear',
    mood: 'wry, protective, and more ceremonial than solitary, keeping the answer beneath a smile',
...
const AUDIT_NOTES: Record<string, string> = {
  'ac-artoria-once-future': 'UR box-art read is strong; crown has generous sky and the face lands near y 331.',
  ...
  'ac-lancelot-moonlit-shame': 'Dual blades and tears read immediately; the second blade grip is intentionally softer in the approved raw.',
  ...
  'ac-velvet-court-spy': 'The bright princess-knight register is accepted even though the stealth read is weak; face near y 161.',
  ...
  'ac-grail-hermit': 'The approved register reads as an ornate paladin more than a hermit; face near y 119.',
  ...
  'ac-court-minstrel': 'Lyre is present; the approved pose is relatively static and the face sits near y 156.',
  ...
  'ac-borderland-huntress': 'Drawn bow and correct nock read cleanly; face near y 192.',
  'ac-chapel-mender': 'Halo-mace is the defining approved prop; face near y 167.',
  ...
  'ac-root-chapel-warden': 'Spear tip exiting the top is an approved prop accent; face near y 174.',
  'ac-pennant-carrier': 'Pennant is verified blank; face near y 239.',
  'ac-court-archer': 'Longbow grip reads correctly; face near y 201.',
  'ac-prophecy-attendant': 'Scry-orb tell is clear; face near y 152 benefits from crop zoom.',
};
