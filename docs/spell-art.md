...
## Sands of the Duat Wave C spells (7)
...
- **Prompt:** The warcry effect of a Bastet pride drill, a precise pulse of tomb-gold command-light striking the ground at the exact center of a sandstone training court and sending three clean concentric marching beats through dust and lapis inlay, two small secondary adult Bastet silhouettes braced behind the effect, each secondary figure has face in the upper third with generous empty air above the head, blank standard cloth and blank shield faces with no readable marks, R palette `#d95436`, `#5e0f0f`, `#f7b267` layered with Duat tomb gold, lapis, sandstone, natron white, resin-brown and barge-fire accents, a low brazier as the named practical key and one lapis-cool rim, a generous pool of warm light claiming a large part of the frame, rich readable detail in every shadow, no near-black areas anywhere, darkest visible value resin brown `#3a2a1c`, blank gold cartouche panels, geometric banded registers, all distant walls, pylons, columns and background architecture perfectly smooth blank stone with plain flat geometric banding only, no carved relief anywhere, no heart-red anywhere, no readable text, no letters, no numbers, no nameplates, no hieroglyphs, no glyphs, no writing, no inscriptions, no magic circle, no arcane sigil, no starburst, no radial rays, no glowing orb, no lens flare, no light burst — crisp cel-shaded gacha anime spell illustration, dramatic magical effect centered in frame, fully rendered scenic background, 640×800 portrait

### Bastet Gate-Chorus — `sd-bastet-gate-chorus`
- **Prompt:** The gate-chorus effect of two Bastet kits answering a golden Duat gate, a paired burst of white-gold opening light and lapis dust pushing outward from the exact center of the sandstone threshold, the two small kit silhouettes secondary and tucked behind the effect, each secondary figure has face in the upper third with generous empty air above the head, exactly two small blank kit collars with no emblems and no readable marks, W palette `#f2e8cf`, `#c9a84c`, `#fffef2` layered with Duat tomb gold, lapis, sandstone, natron white, resin-brown and barge-fire accents, a gate brazier as the named practical key and one lapis-cool threshold rim, a generous pool of warm light claiming a large part of the frame, rich readable detail in every shadow, no near-black areas anywhere, darkest visible value resin brown `#3a2a1c`, blank gold cartouche panels, geometric banded registers, all distant walls, pylons, columns and background architecture perfectly smooth blank stone with plain flat geometric banding only, no carved relief anywhere, no heart-red anywhere, no readable text, no letters, no numbers, no nameplates, no hieroglyphs, no glyphs, no writing, no inscriptions, no magic circle, no arcane sigil, no starburst, no radial rays, no glowing orb, no lens flare, no light burst — crisp cel-shaded gacha anime spell illustration, dramatic magical effect centered in frame, fully rendered scenic background, 640×800 portrait

### Salt and Linen — `sd-salt-and-linen`
- **Prompt:** The strengthening effect of salt and linen, a clean natron-white binding ribbon and warm gold restorative weave wrapping around one secondary adult human Duat attendant at the exact center of a salt room, the linen magic itself the hero and the attendant's face in the upper third with generous empty air above the head, every fold and blank seal surface free of readable marks, W palette `#f2e8cf`, `#c9a84c`, `#fffef2` layered with Duat tomb gold, lapis, sandstone, natron white, resin-brown and barge-fire accents, a warm salt-room lamp as the named practical key and one lapis-cool crystal rim, a generous pool of warm light claiming a large part of the frame, rich readable detail in every shadow, no near-black areas anywhere, darkest visible value resin brown `#3a2a1c`, blank gold cartouche panels, geometric banded registers, all distant walls, pylons, columns and background architecture perfectly smooth blank stone with plain flat geometric banding only, no carved relief anywhere, no heart-red anywhere, no readable text, no letters, no numbers, no nameplates, no writing on linen, no writing on seals, no hieroglyphs, no glyphs, no inscriptions, no magic circle, no arcane sigil, no starburst, no radial rays, no glowing orb, no lens flare, no light burst — crisp cel-shaded gacha anime spell illustration, dramatic magical effect centered in frame, fully rendered scenic background, 640×800 portrait

### The Debt Is Called — `sd-the-debt-is-called`
- **Prompt:** The debt-called effect, a deep violet-black voice-wave leaving a blank bronze speaking bowl at the exact center of a resin-brown river hall and traveling across lapis water as two clean expanding wakes, one secondary adult human Duat official in the background with face in the upper third and generous empty air above the head, the bowl and every seal perfectly blank with no readable marks, B palette `#5a3a70`, `#140d1c`, `#9b6fc4` layered with Duat tomb gold, lapis, sandstone, natron white, resin-brown and barge-fire accents, a low oil lamp as the named practical key and one lapis-cool water rim, a generous pool of warm light claiming a large part of the frame, rich readable detail in every shadow, no near-black areas anywhere, darkest visible value resin brown `#3a2a1c`, blank gold cartouche panels, geometric banded registers, all distant walls, pylons, columns and background architecture perfectly smooth blank stone with plain flat geometric banding only, no carved relief anywhere, no heart-red anywhere, no readable text, no letters, no numbers, no nameplates, no words in the bowl, no hieroglyphs, no glyphs, no writing, no inscriptions, no magic circle, no arcane sigil, no starburst, no radial rays, no glowing orb, no lens flare, no light burst — crisp cel-shaded gacha anime spell illustration, dramatic magical effect centered in frame, fully rendered scenic background, 640×800 portrait

### Noon Judgment — `sd-noon-judgment`
- **Prompt:** The noon-judgment effect, a single flat pale-gold vertical judgment beam striking one blank sandstone verdict slab at the exact center of a hard-noon Duat court, the beam's clean impact and heat shimmer the hero, one secondary adult human target silhouette behind the effect with face in the upper third and generous empty air above the head, the slab perfectly smooth and unmarked with no readable surface, R palette `#d95436`, `#5e0f0f`, `#f7b267` layered with Duat tomb gold, lapis, sandstone, natron white, resin-brown and barge-fire accents, one small flat pale-gold circle high in a hazy sky as a matte rayless practical sun and one lapis-cool waterline rim, a generous pool of warm light claiming a large part of the frame, rich readable detail in every shadow, no near-black areas anywhere, darkest visible value resin brown `#3a2a1c`, blank gold cartouche panels, geometric banded registers, all distant walls, pylons, columns and background architecture perfectly smooth blank stone with plain flat geometric banding only, no carved relief anywhere, no heart-red anywhere, no readable text, no letters, no numbers, no nameplates, no inscriptions on the slab, no hieroglyphs, no glyphs, no writing, no magic circle, no arcane sigil, no starburst, no radial rays, no glowing orb, no lens flare, no light burst — crisp cel-shaded gacha anime spell illustration, dramatic magical effect centered in frame, fully rendered scenic background, 640×800 portrait

### Two Harvests — `sd-two-harvests`
- **Prompt:** The two-harvest effect, exactly two fresh flood-fed furrows opening side by side at the exact center of a green Duat field, twin streams of lapis water running into bright barley and lotus shoots as the effect hero, no figures and no faces, one blank sandstone boundary marker with no readable marks, G palette `#4fa06a`, `#123a22`, `#a9dcae` layered with malachite reeds, Duat tomb gold, lapis, sandstone, natron white, resin-brown and barge-fire accents, a warm bank brazier as the named practical key and one lapis-cool water rim, a generous pool of warm light claiming a large part of the frame, rich readable detail in every shadow, no near-black areas anywhere, darkest visible value resin brown `#3a2a1c`, blank gold cartouche panels, geometric banded registers, all distant walls, pylons, columns and background architecture perfectly smooth blank stone with plain flat geometric banding only, no carved relief anywhere, no heart-red anywhere, no readable text, no letters, no numbers, no nameplates, no marks on the boundary stone, no hieroglyphs, no glyphs, no writing, no inscriptions, no magic circle, no arcane sigil, no starburst, no radial rays, no glowing orb, no lens flare, no light burst — crisp cel-shaded gacha anime spell illustration, dramatic magical effect centered in frame, fully rendered scenic background, 640×800 portrait

### Hollow the Chest — `sd-hollow-the-chest`
- **Prompt:** The hollowing effect, a violet-black pressure wave entering a blank natron chestplate at the exact center of a tomb court and collapsing its inner glow into a clean empty cavity, one secondary adult human Duat warrior behind the effect with face in the upper third and generous empty air above the head, the chestplate and any nearby seal perfectly blank with no readable marks, B palette `#5a3a70`, `#140d1c`, `#9b6fc4` layered with Duat tomb gold, lapis, sandstone, natron white, resin-brown and barge-fire accents, a low oil brazier as the named practical key and one lapis-cool wall rim, a generous pool of warm light claiming a large part of the frame, rich readable detail in every shadow, no near-black areas anywhere, darkest visible value resin brown `#3a2a1c`, blank gold cartouche panels, geometric banded registers, all distant walls, pylons, columns and background architecture perfectly smooth blank stone with plain flat geometric banding only, no carved relief anywhere, no heart-red anywhere, no readable text, no letters, no numbers, no nameplates, no writing on armor, no hieroglyphs, no glyphs, no inscriptions, no magic circle, no arcane sigil, no starburst, no radial rays, no glowing orb, no lens flare, no light burst, no gore, no blood — crisp cel-shaded gacha anime spell illustration, dramatic magical effect centered in frame, fully rendered scenic background, 640×800 portrait

### Sealed Doorway — `sd-sealed-doorway`
- **Prompt:** The sealed-doorway effect, a clean white-gold stone door sliding shut across a fading secondary adult human Duat silhouette at the exact center of a sandstone passage, the closing plane and its warm ward-light the hero, the figure's face in the upper third with generous empty air above the head, one large blank gold seal panel on the door with no readable marks, W palette `#f2e8cf`, `#c9a84c`, `#fffef2` layered with Duat tomb gold, lapis, sandstone, natron white, resin-brown and barge-fire accents, a doorway oil lamp as the named practical key and one lapis-cool corridor rim, a generous pool of warm light claiming a large part of the frame, rich readable detail in every shadow, no near-black areas anywhere, darkest visible value resin brown `#3a2a1c`, blank gold cartouche panels, geometric banded registers, all distant walls, pylons, columns and background architecture perfectly smooth blank stone with plain flat geometric banding only, no carved relief anywhere, no heart-red anywhere, no readable text, no letters, no numbers, no nameplates, no writing on the seal, no hieroglyphs, no glyphs, no inscriptions, no magic circle, no arcane sigil, no starburst, no radial rays, no glowing orb, no lens flare, no light burst — crisp cel-shaded gacha anime spell illustration, dramatic magical effect centered in frame, fully rendered scenic background, 640×800 portrait

### Empty Every Jar — `sd-empty-every-jar`
- **Prompt:** The empty-every-jar effect, a sweeping violet-black draining wind crossing the exact center of a vast Duat embalming hall as every open canopic jar releases its last luminous mote into one clean current, the empty jars and moving current are the hero, no readable labels on any vessel, only faint secondary adult human silhouettes deep behind the effect, each secondary figure has face in the upper third with generous empty air above the head, B palette `#5a3a70`, `#140d1c`, `#9b6fc4` layered with Duat tomb gold, lapis, sandstone, natron white, resin-brown and barge-fire accents, multiple low oil lamps as motivated practical keys and one lapis-cool river rim, a generous pool of warm light claiming a large part of the frame, rich readable detail in every shadow, no near-black areas anywhere, darkest visible value resin brown `#3a2a1c`, blank gold cartouche panels, geometric banded registers, all distant walls, pylons, columns and background architecture perfectly smooth blank stone with plain flat geometric banding only, no carved relief anywhere, no heart-red anywhere, no readable text, no letters, no numbers, no nameplates, no writing on jars, no hieroglyphs, no glyphs, no inscriptions, no magic circle, no arcane sigil, no starburst, no radial rays, no glowing orb, no lens flare, no light burst, no gore, no blood — crisp cel-shaded gacha anime spell illustration, dramatic magical effect centered in frame, fully rendered scenic background, 640×800 portrait
