<!-- source-of-truth: index.html, vite.config.ts, package.json, src/main.ts, src/scenes/, src/ui/CardZoomPreview.ts, src/ui/CardView.ts, src/ui/BoardCardView.ts, src/scenes/SettingsScene.ts, src/ui/fx/FXSupport.ts, src/audio/AudioManager.ts, src/meta/SaveManager.ts, src/meta/services.ts, src/engine/Game.ts, src/engine/actions.ts, src/engine/view.ts, src/engine/events.ts, src/engine/types.ts, src/ai/AIPlayer.ts, src/ai/determinize.ts, src/art/ArtResolver.ts, src/config/rules.ts · last-verified: 2026-07-11 · plan doc — grounded in the 2026-07-02/03 mobile audits; Tier 1 shipped (2026-07-06 status note below), Tier 2 still a plan; re-verify when each tier ships -->
