...
Status: ALL FIVE PHASES BUILT. PHASE D BUILT 2026-09-17 (the draft picker reads the whole card, Bulwark and Rage earn nothing, self-damage is not removal, lockstep pins re-baselined deliberately, 40 of 40 behaviour tests pass; measured: mechanic-aware picks do not draft stronger decks for Medium, so the shipped weights are mechanic 1 and buff 0 by owner ruling; the measurement also found the Saint of the Lamp Oil trigger loop, closed by #381). PHASES E (#375), A (#376), B (#377), C (#380) LANDED; PHASE C BUILT 2026-09-16 (combat keywords: the shared exchange model, Easy's first-strike block math, Hard's move guard; 37 of 40 behaviour tests pass, D owns the three left; twinBlades on both seats cost Bastet 6.6 points because her opponents had been misblocking her double-strikers, so she got a measured reserve tune, 62.4 to 73.6, instead of a floor change). OWNER HOLD before D. TUNING PASSES LANDED (#378, #379) 2026-09-16 (Tithe rate measured and kept at 0.2: V1/V2/V3 all inside the band; Lanterns Below L1+L3+L4 14.6 to 31.3; the Deacon D1+D2+D5 35.9 to 66.4, rung 25 gate 40.0 to 63.5; a Still Harbour counter-retarget hard-lock fixed in MediumAI). OWNER HOLD before C or D. PHASE B BUILT 2026-09-15 (Tithe, Hauntlink, Duty, Empower; 34 of 40 behaviour tests pass, C and D own the six left; the Marsh-Mother measured 77.9 to 74.8 after the Tithe fodder rule, the tuning pass's first knob). OWNER HOLD before C, D or any tuning. PHASE A BUILT 2026-09-15 (the cast ladder, Hard's pass; 31 of 40 behaviour tests pass, B/C/D own the nine left; the untuned Deacon moved 33 to 35.5 and Lanterns Below 18.9 to 20.1, so both decks owe a tuning pass). PLAN AUTHORIZED 2026-09-15 (D1 all five phases, D2 proof first, D3 style over strength; D4 and D5 approved as recommended in section 8). The owner asked
