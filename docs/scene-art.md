...
- **Deliverable: 1280×720 WebP** — the game's design resolution
...
- **Deliverable:** 1280×720 WebP (landscape stage).
...
### Card Back — `card-back`
- **Role:** The face-down card design. Today `bakeCardFrames` (`src/ui/CardFrameFactory.ts`) paints a procedural 600×840 `cardback` canvas — dark violet radial field (`#3a2a55` → `#171024`) on `#141318`, gold border `#8a6d1f`, inner hairline, and a triple gold diamond sigil with a `#d4af37` core — which `CardView.back` displays at 300×420. **Face-down cards render via `CardView.setCard(null)`, used today by `PackOpeningScene`** (commons dealt face-down + the specials row). Since 2026-08-24 `DuelScene` also renders card backs: the mulligan and bottoming ritual draws the LIBRARY as a stack of them at 124x172, using the active deck's chosen back (save v33). The opponent hand remains a HUD count. Any future face-down context inherits this texture automatically.
- **Deliverable:** 640×800 WebP (portrait, 4:5 — same as card faces).
...
### Card Back, Storm Gold — `card-back-ragnarok-storm-gold`
- **Role:** The `back-ragnarok-storm-gold` cosmetic (`src/meta/cosmetics.ts`). Painted procedurally by `bakeStyledCardBack` until 2026-08-24; the Ragnarök-flavoured back, blurb "Thunder has a filing system. It is mostly gold."
- **Deliverable:** 640×800 WebP (portrait, 4:5 — same as the default back).
- **Mood & palette:** Storm-forged gold on near-black bitumen. Field `#17120d` deepening to `#24180d`, ornament in tarnished bronze-gold `#70531f` rising to a bright `#f1c35b` core. Colder and harder than the house violet back; the metal should read as struck, not gilded.
- **Composition & safe zones:** Ornamental and **fully symmetric on both axes**. A central gold thunder-sigil (a stylised bolt bound inside a ring), concentric Norse knotwork frames, mirrored corner flourishes shaped like anvil horns, faint engraved storm lines radiating outward. Integration cover-crops 640×800 → 600×840, cutting **≈ 34 px off each side** — all border ornament and anything whose symmetry matters stays inside **x 34–606**; full height survives.
- **Max luminance:** average ≤ 20 %; peak ≤ 60 % (bolt core only). It sits behind face-up cards in the same shot and must not out-shout them.
- **Integration:** `bakeCardFrames` draws it cover-cropped into the 600×840 `cardback-back-ragnarok-storm-gold` canvas inside the rounded-rect clip (r 34); falls back to `bakeStyledCardBack` when absent.
- **QA:** Flip horizontal — identical within x 34–606. Reads as a card back at 0.1 scale and at the 124×172 the mulligan library draws. Zero letterforms, no runic writing (knotwork only).
- **Prompt:** Ornate symmetrical trading-card back design, a large brightly lit tarnished-gold thunder sigil of a stylised lightning bolt bound inside a ring filling the centre, heavy bronze and gold Norse knotwork frames clearly visible around it, mirrored corner flourishes shaped like anvil horns, engraved storm lines radiating outward, warm metallic highlights catching every ornament edge, all of it set on a deep charcoal-brown field, perfect two-axis symmetry, blank of any lettering or runes — crisp cel-shaded gacha anime ornamental card-back art, 640×800 portrait

### Card Back, Moonlit Veil — `card-back-silver-veil-moonlit`
- **Role:** The `back-silver-veil-moonlit` cosmetic. Procedural until 2026-08-24; blurb "Silver light, a patient crescent, and one secret kept behind glass."
- **Deliverable:** 640×800 WebP (portrait, 4:5).
- **Mood & palette:** Cold silver-blue night. Field `#0d1420` to `#101b31`, ornament in slate blue `#324b70` lifting to pale moon-silver `#c4e0ff`. The one back allowed to feel translucent rather than metal.
- **Composition & safe zones:** Ornamental and **fully symmetric on both axes**. A central waning crescent held behind a pane of frosted glass, concentric silver filigree frames of thin interlocking arcs, mirrored corner flourishes like frost growth, a veil of fine parallel hatching drawn across the whole field. Cover-crop 640×800 → 600×840 cuts **≈ 34 px off each side** — keep all ornament inside **x 34–606**.
- **Max luminance:** average ≤ 20 %; peak ≤ 60 % (crescent only). The pale palette makes this the easiest entry to overexpose: keep the field genuinely dark and let only the crescent approach the cap.
- **Integration:** As the default back, into `cardback-back-silver-veil-moonlit`; falls back to `bakeStyledCardBack`.
- **QA:** Flip horizontal — identical within x 34–606. Confirm the average luminance cap holds despite the silver palette. Zero letterforms.
- **Prompt:** Ornate symmetrical trading-card back design on a very dark near-black midnight blue field, a single pale waning crescent moon behind frosted glass as the ONLY bright element, concentric silver filigree frames of thin interlocking arcs rendered dim and shadowed in dark pewter rather than bright silver, mirrored corner flourishes growing like frost kept deep in shadow, a veil of fine parallel hatching across the field, heavily shadowed overall with most of the card in darkness, perfect two-axis symmetry, blank of any lettering — crisp cel-shaded gacha anime ornamental card-back art, 640×800 portrait

### Card Back, Cursed Storybook — `card-back-dark-tales-storybook`
- **Role:** The `back-dark-tales-storybook` cosmetic, the Dark Tales back. Procedural until 2026-08-24; blurb "The cover is shut. The story is still making plans."
- **Deliverable:** 640×800 WebP (portrait, 4:5).
- **Mood & palette:** Plum leather and tarnished rose. Field `#1a1018` to `#261020`, ornament in deep wine `#6b314f` lifting to dusty rose `#e2a2bd`. It should read as a closed book cover, not a card printed with a book.
- **Composition & safe zones:** Ornamental and **fully symmetric on both axes**. The whole card IS the book: a tooled leather cover with a raised central medallion, a vertical clasp strap running top to bottom through the centre with its lock at the middle, concentric thorned-vine frames, mirrored corner bosses. Cover-crop cuts **≈ 34 px off each side** — keep the clasp and every boss inside **x 34–606**.
- **Max luminance:** average ≤ 20 %; peak ≤ 60 % (the clasp's metal catch only).
- **Integration:** As the default back, into `cardback-back-dark-tales-storybook`; falls back to `bakeStyledCardBack`.
- **QA:** Flip horizontal — identical within x 34–606; the clasp must be dead-centre or the mirror fails. Zero letterforms, and no title panel on the cover.
- **Prompt:** Ornate symmetrical trading-card back design shaped as a closed book cover, tooled plum leather field, a raised central medallion of tarnished rose metal, a vertical clasp strap running the full height through the centre with its lock at the middle, concentric thorned-vine frames, mirrored corner bosses, deep wine and dusty rose palette kept dark, perfect two-axis symmetry, blank of any lettering and no title panel — crisp cel-shaded gacha anime ornamental card-back art, 640×800 portrait

### Card Back, Neon Yokai — `card-back-yokai-neon`
- **Role:** The `back-yokai-neon` cosmetic, the Yokai Nights back. Procedural until 2026-08-24; blurb "Bright signs, bad omens, excellent timing."
- **Deliverable:** 640×800 WebP (portrait, 4:5).
- **Mood & palette:** Wet black lacquer under cyan sign-light. Field `#071516` to `#071d27`, ornament in deep teal `#0b5554` lifting to a bright fox-fire cyan `#68f3dc`. The only back with an emissive palette, so the darkness discipline does the heavy lifting.
- **Composition & safe zones:** Ornamental and **fully symmetric on both axes**. A central hollow fox-mask emblem, an ornament rather than a character's face, rendered as a single unbroken neon tube line, a torii silhouette framing it, concentric frames of neon piping with visible tube ends, mirrored corner flourishes of drifting fox-fire motes, faint wet reflections below. Cover-crop cuts **≈ 34 px off each side** — keep all piping inside **x 34–606**.
- **Max luminance:** average ≤ 20 %; peak ≤ 60 % (the brightest tube run only). Neon tempts a bright frame: the lacquer field must stay near-black so the tubes read as light rather than as paint.
- **Integration:** As the default back, into `cardback-back-yokai-neon`; falls back to `bakeStyledCardBack`.
- **QA:** Flip horizontal — identical within x 34–606. Confirm the tubes still read at 0.1 scale without blooming into a solid shape. Zero letterforms, and no shop signage or kana anywhere.
- **Prompt:** Ornate symmetrical trading-card back design, near-black wet lacquer field, a central hollow fox-mask emblem hanging as an ornament, an object and not a character's face, drawn as one unbroken cyan neon tube line, a torii silhouette framing it, concentric frames of neon piping with visible tube ends, mirrored corner flourishes of drifting fox-fire motes, faint wet reflections below, emissive teal and cyan on a genuinely dark ground, perfect two-axis symmetry, blank of any lettering, no signage and no kana — crisp cel-shaded gacha anime ornamental card-back art, 640×800 portrait

### Card Back, Seed of Light — `card-back-starborne-seed`
- **Role:** The `back-starborne-seed` cosmetic, the Starborne back. Procedural until this asset ships; blurb "Plant one light and count again tomorrow."
- **Deliverable:** 640×800 WebP (portrait, 4:5).
- **Mood & palette:** A living hull grown shut around one seed of light. Field hull dusk `#1a1430` to `#241b3e`, ornament in chrome `#8b97a5` lifting to pearl `#c8d2dc`, nebula violet `#7b4bd8` as the soft secondary, and biolume cyan `#5ff0e0` ONLY inside the central seed emblem and its three rising motes — the Mark motif is the one lawful home for cyan, and it stays there.
- **Composition & safe zones:** Ornamental and **fully symmetric on both axes**. The whole card is a pearlescent hull plate: a central teardrop seed emblem inlaid as living light with three small motes rising through it (largest at the base, smallest at the tip), concentric frames of chrome hull ribs, mirrored corner bosses as smooth pearl nodes, faint membrane filigree between the frames. Cover-crop cuts **≈ 34 px off each side** — keep every rib and boss inside **x 34–606**.
- **Max luminance:** average ≤ 20 %; peak ≤ 60 % (the seed core only).
- **Integration:** As the default back, into `cardback-back-starborne-seed`; falls back to `bakeStyledCardBack`.
- **QA:** Flip horizontal — identical within x 34–606; the seed and its three motes must sit dead-centre on the vertical axis. Cyan appears nowhere but the seed and motes. Zero letterforms.
- **Prompt:** Ornate symmetrical trading-card back design shaped as a pearlescent living-hull plate, dark violet-dusk field, a central teardrop seed emblem inlaid as glowing biolume cyan living light with exactly three small round motes rising through it, largest at the base and smallest at the tip, concentric frames of chrome hull ribs, mirrored corner bosses of smooth pearl, faint organic membrane filigree between the frames, chrome and pearl ornament over deep violet dusk with soft nebula violet accents, the cyan strictly confined to the seed and its three motes, perfect two-axis symmetry, blank of any lettering — crisp cel-shaded gacha anime ornamental card-back art, 640×800 portrait
...
- **Deliverable:** 640×800 WebP (portrait).
...
- **Composition & safe zones:** Integration cover-crops 640×800 → 560×800 (7:10), cutting **≈ 40 px off each side** — keep all trim and the sigil inside **x 40–600**. Keep the top and bottom **~52 px free of ornament** because code overlays the crimp zones there.

> **The crimp-zone rule (binding for every pack front).** "Free of ornament"
> means no trim, filigree, sigil, or glints in the top and bottom ~52 px. It
> does **not** mean paint a bar there: the background art must run all the way
> to the top and bottom edges. A source that bakes its own flat dark bars ends
> up letterboxed twice, because `bakePackArt` stamps the crimp over whatever it
> is given. Measured 2026-07-29, the three sources authored under the earlier
> "solid matte near-black bars, as if masked off" phrasing had baked bars of
> 73/72 px (Gothic Monsters), 52/52 px (Dark Tales), and 69/67 px (Yokai
> Nights), wasting 13–18 % of each pack face; the four older sources carry 0–7
> px and always rendered correctly. Those three are compensated in code by
> `PackArtOpts.trimY` in `src/scenes/ShopScene.ts`. **If any of them is ever
> regenerated under the corrected wording above, drop its `trimY` back to 0.**
...
- **Composition & safe zones:** Identical to `pack-art` — cover-crop cuts ≈40 px per side (keep trim + sigil inside x 40–600); the top and bottom ~52 px are the code-stamped crimp zones, so no filigree, trim, lace, roses, glints, or ornament of any kind may enter them (user review 2026-07-18: the prior render ran filigree into the crimp bands), but the background must still run through them to the edge. See the crimp-zone rule under `pack-art`.
...
- **QA:** Reads as sealed product at 238×340; crimp zones unornamented but still carrying background to the edge, never flat bars, per the crimp-zone rule; zero letterforms (invitations, seals, and lace stay blank or patterned, never lettered).
- **Prompt:** Booster pack front key art, the top and bottom edges carrying only quiet unornamented background atmosphere that runs all the way to the edge, zero ornament, zero gold, zero trim, zero filigree, zero pattern there, and never a flat black bar or letterbox, a golden diamond sigil wreathed in black lace and dark crimson grave roses floating over rich crimson velvet drapery and moonlit gothic stone, warm candlelight rising from below against a cold storm-blue upper gloom crossed by one thin white lightning glint, ornate cathedral-gold trim frame confined to the middle of the composition, faint sparkling foil glints only in the central art, all decoration ending well before the top and bottom edges, dramatic sealed-product presentation with no lettering, crisp cel-shaded gacha anime booster-pack key art, 640×800 portrait — the top and bottom edges carrying only quiet unornamented background atmosphere that runs all the way to the edge, zero ornament, zero gold, zero trim, zero filigree, zero pattern there, and never a flat black bar or letterbox

### Dark Tales Booster Pack Front — `pack-art-dark-tales`
- **Role:** The Dark Tales expansion booster in `ShopScene`'s pack row and its `PackOpeningScene` tear. Consumed by `bakePackArt` via `DARK_TALES_PACK_ART` (`packart-dark-tales` / `scene-pack-art-dark-tales`); until this asset ships the SKU falls back to the procedural midnight-violet tinted pack.
- **Deliverable:** 640×800 WebP (portrait).
- **Mood & palette:** Dark Tales as sealed product: midnight blue-violet gloom over silver-thorned briar, gold-leaf storybook filigree, pale moonlight, a single glass-slipper glint at the sigil's foot. Distinct from Nocturne Manor's crimson velvet: this pack reads as a cursed fairytale storybook, glamorous and adult, never cute. Same product-hero saturation allowance as `pack-art`.
- **Composition & safe zones:** Identical to `pack-art` — cover-crop cuts ≈40 px per side (keep trim + sigil inside x 40–600); the top and bottom ~52 px are the code-stamped crimp zones, so no filigree, trim, thorns, glints, or ornament of any kind may enter them (the Gothic Monsters lesson, user review 2026-07-18), but the background must still run through them to the edge. See the crimp-zone rule under `pack-art`.
- **Max luminance:** average ≤ 25 %; peak ≤ 70 % (moonlight / slipper glint / sigil core).
- **Integration:** `bakePackArt(scene, DARK_TALES_PACK_ART)` — already wired; the asset landing on disk + manifest is the whole switch.
- **QA:** Reads as sealed product at 238×340; crimp zones unornamented but still carrying background to the edge, never flat bars, per the crimp-zone rule; zero letterforms (the storybook motif stays closed or shows blank decorative pages, never lettered).
- **Prompt:** Booster pack front key art, the top and bottom edges carrying only quiet unornamented background atmosphere that runs all the way to the edge, zero ornament, zero gold, zero trim, zero filigree, zero pattern there, and never a flat black bar or letterbox, a golden diamond sigil wreathed in silver briar thorns and deep violet rose vines floating over a closed gold-leaf storybook and midnight blue-violet gloom, pale moonlight falling from above and one small glass-slipper glint below the sigil, ornate gold trim frame confined to the middle of the composition, faint sparkling foil glints only in the central art, all decoration ending well before the top and bottom edges, dramatic sealed-product presentation with no lettering, crisp cel-shaded gacha anime booster-pack key art, 640×800 portrait — the top and bottom edges carrying only quiet unornamented background atmosphere that runs all the way to the edge, zero ornament, zero gold, zero trim, zero filigree, zero pattern there, and never a flat black bar or letterbox

### Yokai Nights Booster Pack Front — `pack-art-yokai-nights`
- **Role:** The Yokai Nights expansion booster in `ShopScene`'s pack row and its `PackOpeningScene` tear. Consumed by `bakePackArt` via `YOKAI_NIGHTS_PACK_ART` (`packart-yokai-nights` / `scene-pack-art-yokai-nights`); until this asset ships the SKU falls back to the procedural teal-tinted pack.
- **Deliverable:** 640×800 WebP (portrait).
- **Mood & palette:** Yokai Nights as sealed product: electric magenta and cyan neon against rain-slick black glass, holographic lantern glow, a blank kitsune mask and thin neon torii silhouette behind the sigil, gold trim continuity with the other packs. Deliberately apart from Nocturne Manor's crimson velvet and Dark Tales' midnight violet: this pack reads as neon-noir yokai metropolis merchandise, glamorous and adult, never cute. Same product-hero saturation allowance as `pack-art`.
- **Composition & safe zones:** Identical to `pack-art` — cover-crop cuts ≈40 px per side (keep trim + sigil inside x 40–600); the top and bottom ~52 px are the code-stamped crimp zones, so no filigree, trim, neon tubes, rain streaks, glints, or ornament of any kind may enter them (the Gothic Monsters lesson, user review 2026-07-18), but the background must still run through them to the edge. See the crimp-zone rule under `pack-art`.
- **Max luminance:** average ≤ 25 %; peak ≤ 70 % (neon glow / holo glints / sigil core).
- **Integration:** `bakePackArt(scene, YOKAI_NIGHTS_PACK_ART)` — already wired; the asset landing on disk + manifest is the whole switch.
- **QA:** Reads as sealed product at 238×340; crimp zones unornamented but still carrying background to the edge, never flat bars, per the crimp-zone rule; zero letterforms (every lantern panel and holo screen is blank or carries a single geometric emblem, never glyph columns — the set's blank-signage rule applies at pack scale too).
- **Prompt:** Booster pack front key art, the top and bottom edges carrying only quiet unornamented background atmosphere that runs all the way to the edge, zero ornament, zero gold, zero trim, zero neon, zero pattern there, and never a flat black bar or letterbox, a golden diamond sigil glowing like a holographic emblem before a blank white kitsune mask and a thin electric magenta torii gate silhouette, floating over rain-slick black glass towers with cyan and magenta neon reflections and blank holographic lantern panels, ornate gold trim frame confined to the middle of the composition, faint sparkling foil glints only in the central art, all decoration ending well before the top and bottom edges, dramatic sealed-product presentation with no lettering and no glyphs on any lantern or screen, crisp cel-shaded gacha anime booster-pack key art, 640×800 portrait — the top and bottom edges carrying only quiet unornamented background atmosphere that runs all the way to the edge, zero ornament, zero gold, zero trim, zero neon, zero pattern there, and never a flat black bar or letterbox

### Sands of the Duat Booster Pack Front — `pack-art-sands-of-the-duat`
- **Role:** The Sands of the Duat expansion booster in `ShopScene`'s pack row and its `PackOpeningScene` tear. Consumed by `bakePackArt` via `SANDS_OF_THE_DUAT_PACK_ART` (`packart-sands-of-the-duat` / `scene-pack-art-sands-of-the-duat`); until this asset ships the SKU falls back to the procedural lapis-tinted pack. The SKU itself is liveness-gated: it enters the shop row only when `FEATURES.duatLive` flips at the shared balance pass.
- **Deliverable:** 640×800 WebP (portrait).
- **Mood & palette:** The Sealed Door (promoted from the drafts-file brief): a vertical lapis panel framed by a deliberately blank gold cartouche border, Bastet's profile as a flat gold-leaf silhouette backed by a rising barge-fire sun disc, sandstone texture at the panel edges only, a hairline crack across the middle of the intact seal as the tear line. Exactly three lapis values `#16294f` / `#1f3f7a` / `#2f5fae`, two gold values `#c9a84c` / `#e8c95a`, one barge-fire value `#ff8a3d`. No heart-red `#c8253a` anywhere on the pack; no true black — resin brown `#3a2a1c` is the depth floor. Deliberately apart from the three night packs: this pack reads as sealed tomb-door product, monumental and bright-metaled, never cluttered.
- **Composition & safe zones:** Identical to `pack-art` — cover-crop cuts ≈40 px per side (keep border + profile inside x 40–600); the top and bottom ~52 px are the code-stamped crimp zones, so no cartouche border, gold trim, fire glow, dust motes, or ornament of any kind may enter them (the Gothic Monsters lesson, user review 2026-07-18), but the lapis panel background must still run through them to the edge. See the crimp-zone rule under `pack-art`. Symmetrical, vertical, and sealed; the Bastet profile stays a flat silhouette with no facial detail; the hairline tear crosses the middle.
- **Max luminance:** average ≤ 25 %; peak ≤ 70 % (sun disc / gold leaf / seal glint).
- **Integration:** `bakePackArt(scene, SANDS_OF_THE_DUAT_PACK_ART)` — wired with the SKU; the asset landing on disk + manifest is the whole switch.
- **QA:** Reads as sealed product at 238×340; crimp zones unornamented but still carrying lapis background to the edge, never flat bars; zero letterforms (the cartouche border and every band stays blank — the set's NO-TEXT register applies at pack scale); the set symbol is a shape-only gold mark, never letters or glyph-like writing.
- **Prompt:** Booster pack front key art, the top and bottom edges carrying only quiet unornamented lapis panel background that runs all the way to the edge, zero ornament, zero gold, zero trim, zero fire glow, zero pattern there, and never a flat black bar or letterbox, a symmetrical vertical sealed tomb door as sealed product, lapis panel in exactly three lapis values `#16294f`, `#1f3f7a`, `#2f5fae`, framed by a deliberately blank gold cartouche border in exactly two gold values `#c9a84c`, `#e8c95a` confined to the middle of the composition, flat gold-leaf Bastet cat-profile silhouette with no facial detail backed by one rising barge-fire orange sun disc `#ff8a3d` as named practical key, sandstone texture only at the panel edges, one hairline crack across the middle of the intact seal, one lapis-cool rim from the panel edge and seal inlay, faint gold foil glints only in the central art, all decoration ending well before the top and bottom edges, dramatic sealed-product presentation with no lettering, NO-TEXT, no hieroglyphs, no glyphs, no writing, no inscriptions, no face detail, no characters, no heart-red anywhere, no true black, darkest visible value resin brown `#3a2a1c`, crisp cel-shaded gacha anime booster-pack key art, 640×800 portrait — the top and bottom edges carrying only quiet unornamented lapis background that runs all the way to the edge, zero ornament, zero gold, zero trim, zero pattern there, and never a flat black bar or letterbox

### Starborne Booster Pack Front — `pack-art-starborne`
- **Role:** The Starborne expansion booster in `ShopScene`'s pack row and its `PackOpeningScene` tear. Consumed by `bakePackArt` via `STARBORNE_PACK_ART` (`packart-starborne` / `scene-pack-art-starborne`); until this asset ships the SKU falls back to the procedural violet-tinted pack.
- **Deliverable:** 640×800 WebP (portrait).
- **Mood & palette:** A living hull wrapped as product: a vertical pearlescent hull panel with breathing seams, framed by a deliberately blank chrome border, the seed-of-light set emblem at centre as inlaid living light, a violet cloudbank glow behind the panel edges. Exactly three hull values `#e8ecf5` / `#c8d2dc` / `#8b97a5`, two violet values `#7b4bd8` / `#2a2140`, and biolume cyan `#5ff0e0` ONLY in the seed emblem and its three motes. No true black — hull dusk `#2a2140` is the depth floor. Apart from every other pack: this one reads as grown, not manufactured.
- **Composition & safe zones:** Identical to `pack-art` — cover-crop cuts ≈40 px per side (keep border + emblem inside x 40–600); the top and bottom ~52 px are the code-stamped crimp zones, so no border, chrome trim, glow, motes, or ornament of any kind may enter them, but the pearl hull panel background must still run through them to the edge. Symmetrical and vertical; the seed emblem stays a flat inlaid shape with no scene behind it; one hairline seam crosses the middle as the tear line.
- **Max luminance:** average ≤ 25 %; peak ≤ 70 % (the seed core and one pearl highlight).
- **Integration:** `bakePackArt(scene, STARBORNE_PACK_ART)` — wired with the SKU; the asset landing on disk + manifest is the whole switch.
- **QA:** Reads as sealed product at 238×340; crimp zones unornamented but still carrying pearl background to the edge, never flat bars; cyan confined to the seed emblem; zero letterforms — the set's NO-TEXT register applies at pack scale.
- **Prompt:** Booster pack front key art, the top and bottom edges carrying only quiet unornamented pearl hull background that runs all the way to the edge, zero ornament, zero chrome, zero trim, zero glow, zero pattern there, and never a flat black bar or letterbox, a symmetrical vertical pearlescent living-hull panel as sealed product with soft breathing seams, exactly three hull values `#e8ecf5`, `#c8d2dc`, `#8b97a5`, framed by a deliberately blank chrome border confined to the middle of the composition, a central flat inlaid teardrop seed emblem of glowing biolume cyan living light `#5ff0e0` with exactly three small round motes rising through it, a violet cloudbank glow `#7b4bd8` behind the panel edges, one hairline seam crossing the middle as the tear line, all decoration ending well before the top and bottom edges, dramatic sealed-product presentation with no lettering, NO-TEXT, no writing, no inscriptions, no characters, no faces, cyan strictly confined to the seed emblem and its motes, no true black, darkest visible value hull dusk `#2a2140`, crisp cel-shaded gacha anime booster-pack key art, 640×800 portrait — the top and bottom edges carrying only quiet unornamented pearl hull background that runs all the way to the edge, zero ornament, zero chrome, zero trim, zero pattern there, and never a flat black bar or letterbox

### Drowned Deep Booster Pack Front — `pack-art-drowned-deep`
- **Role:** The Drowned Deep expansion booster in `ShopScene`'s pack row and its `PackOpeningScene` tear. Consumed by `bakePackArt` via `DROWNED_DEEP_PACK_ART` (`packart-drowned-deep` / `scene-pack-art-drowned-deep`) once the retail wiring lands with the set data; until then the asset is inert on disk. Shop blurb, proposed: "The lamps are lit, and the Deep is owed."
- **Deliverable:** 640×800 WebP (portrait).
- **Mood & palette:** Still black water wrapped as product: a vertical panel of flat black water `#0d1a22` to `#16303a`, framed by a deliberately blank border of wet granite grey `#7d8590` with a single thread of salt-white `#eef0ea` foam along its inner edge, the drowned-bell set emblem at centre inlaid in bell bronze `#a8783c` (a bell with one wave band punched across its lower body and the clapper hanging free below the lip), and the register's reserved drowned gold `#d6e07c` rising from below the surface of the water directly beneath the emblem and nowhere else. No lamps, no amber, no cyan. No true black; wet-stone grey `#2b3238` is the depth floor. Apart from every other pack: this one reads as a still surface with something under it.
- **Composition & safe zones:** Identical to `pack-art` — cover-crop cuts ≈40 px per side (keep border and emblem inside x 40–600); the top and bottom ~52 px are the code-stamped crimp zones, so no border, foam, gold, glow or ornament of any kind may enter them, but the black-water panel background must still run through them to the edge. Symmetrical and vertical; the emblem stays a flat inlaid shape with no scene behind it; one hairline seam crosses the middle as the tear line.
- **Max luminance:** average ≤ 20 %; peak ≤ 60 % (the drowned gold under the emblem and the foam thread only).
- **Integration:** `bakePackArt(scene, DROWNED_DEEP_PACK_ART)` — wired with the SKU in the retail wave; the asset landing on disk + manifest is the whole switch.
- **QA:** Reads as sealed product at 238×340; crimp zones unornamented but still carrying black-water background to the edge, never flat bars; drowned gold confined to the water beneath the emblem, none on the bronze; no amber, no cyan; the bell reads as the set symbol at 40 px; zero letterforms — the set's sea NO-TEXT register applies at pack scale.
- **Prompt:** Booster pack front key art, the top and bottom edges carrying only quiet unornamented still black-water background that runs all the way to the edge, zero ornament, zero trim, zero foam, zero glow, zero pattern there, and never a flat black bar or letterbox, a symmetrical vertical panel of flat still black water `#0d1a22` to `#16303a` as sealed product with faint surface reflections, framed by a deliberately blank border of wet granite grey `#7d8590` confined to the middle of the composition, the border's top edge and bottom edge and any ornament on them at least 110 px inside the top and bottom canvas edges so a broad band of plain water lies above and below the frame, with a single thin thread of salt-white `#eef0ea` foam along its inner edge, a central flat inlaid emblem in bell bronze `#a8783c` shaped as a plain bell with one wavy water band cut across its lower body and a round clapper hanging free below its lip, a soft glow of drowned gold `#d6e07c` rising from below the surface of the water directly beneath the emblem only, the water the only bearer of that gold and none of it on the bronze or the granite, no lamps, no amber light, no cyan anywhere, one hairline seam crossing the middle as the tear line, all decoration ending well before the top and bottom edges, dramatic sealed-product presentation with no lettering, NO-TEXT, no writing, no inscriptions, no characters, no faces, no lettered bells, no true black, darkest visible value wet-stone grey `#2b3238`, crisp cel-shaded gacha anime booster-pack key art, 640×800 portrait
...
- Assets land at **`public/assets/art/scenes/<asset-key>.webp`** (the filename
  minus `.webp` is the asset key from the section-2 heading). This is where
...
- **Mechanism (implemented): `scripts/gen-art-manifest.ts`** scans the scenes
  ...
  queues `load.image('scene-<key>', 'assets/art/scenes/<key>.webp')` for each
