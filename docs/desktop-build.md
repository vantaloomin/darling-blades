<!-- source-of-truth: src-tauri/tauri.conf.json, src-tauri/Cargo.toml, src-tauri/src/lib.rs, src-tauri/capabilities/default.json, src/platform/desktopWindow.ts, package.json, vite.config.ts · last-verified: 2026-07-10 · re-verify when the Tauri config or build scripts change -->
...
- **`icons/`** — generated by `tauri icon` from the card-back emblem
  (`public/assets/art/scenes/card-back.webp`, center-cropped square). Regenerate
