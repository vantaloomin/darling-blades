...
| `boost`                                      | `{ p: number; t: number; keywords?: Keyword[]; scope: 'target'\|'allYours'\|'all' }` | Until-end-of-turn `+p/+t` (+ keywords). `target` → `targets[0]`; `allYours` → every creature you control.                                                                                                                                                                                                                                                                                                                                                          | (via stat recompute)           |
