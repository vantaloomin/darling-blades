...
| `exile`         | `{ to: 'target' }`                                                            | (describe me)                                                                                                                                                                                                                                         | —                              |
| `exileGrave`    | `{ n: number; who: 'self'\|'opponent' }`                                      | (describe me)                                                                                                                                                                                                                                         | —                              |
| `exileTop`      | `{ n: number; who: 'self' }`                                                  | (describe me)                                                                                                                                                                                                                                         | —                              |
