<!-- source-of-truth: package.json, eslint.config.js, .github/workflows/deploy.yml · last-verified: 2026-07-10 · process doc — re-verify when the workflow itself changes -->
