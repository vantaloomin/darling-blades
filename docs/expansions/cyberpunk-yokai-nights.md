<!-- source-of-truth: src/engine/types.ts · last-verified: 2026-07-07 · concept doc — future expansion, not implemented (planned src/data/cards/cyberpunk-yokai-nights.ts); anti-rot anchors on the Keyword/EffectOp vocabulary the card tables must stay legal against -->
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| yn-kagura-neon-kitsune | Kagura, Neon Kitsune | UR | U/R | Legendary Creature | Kitsune hacker | warcry, equipment payoff, modal cast bonus | Set face, tempo boss |
| yn-chrome-oni-shogun | Chrome Oni Shogun | UR | B/R | Legendary Creature | Oni street boss | menace, equipment boost | Aggro boss |
| yn-yurei-idol-zero | Yurei Idol Zero | UR | U/B | Legendary Creature | Ghost idol AI | skyborne, modal drain/draw | Control marquee |
| yn-amaterasu-mainframe | Amaterasu Mainframe | UR | W/U | Legendary Artifact Creature | Shrine sun AI | sentinel, equipment protection | Artifact marquee |
| yn-eightfold-neon-blade | Eightfold Neon Blade | SSR | C | Legendary Artifact Equipment | Mythic cyber-katana | equip, twinBlades grant | Equipment chase |
| yn-jade-firewall-miko | Jade Firewall Miko | SSR | W/U | Legendary Creature | Shrine hacker priestess | untouchable, modal protection | Control legend |
...
| yn-tengu-rooftop-ace | Tengu Rooftop Ace | SSR | U/R | Legendary Creature | Tengu courier | skyborne, warcry | Evasive finisher |
| yn-neon-hyakki-yagyo | Neon Hyakki Yagyo | SSR | B/R | Ritual | Night parade | modal sweep/token/drain | Big modal spell |
| yn-foxfire-rig | Foxfire Rig | SR | U/R | Artifact Equipment | Kitsune gear | equip, scry on hit | Tempo equipment |
| yn-oni-impact-frame | Oni Impact Frame | SR | R | Artifact Equipment | Power armor | equip, overrun/menace | Aggro equipment |
| yn-shrine-drone-swarm | Shrine Drone Swarm | SR | W/U | Artifact Creature | Shrine drones | skyborne, sentinel | Artifact payoff |
| yn-yokai-black-market | Yokai Black Market | SR | B | Enchantment | Spirit market | modal bargain, draw/lose | Value engine |
| yn-rain-slick-assassin | Rain-Slick Assassin | SR | U/B | Creature | Nekomata killer | deathblade, unblockable note | Removal threat |
| yn-neon-torii-gate | Neon Torii Gate | SR | C | Artifact | Cyber shrine gate | modal mana/scry/token | Utility relic |
| yn-katana-overclock | Katana Overclock | SR | R | Charm | Weapon hack | modal boost/damage/equip | Combat trick |
| yn-kitsune-packet-runner | Kitsune Packet Runner | R | U/R | Creature | Kitsune courier | warcry, scry | Tempo rare |
| yn-oni-bouncer | Oni Bouncer | R | B/R | Creature | Club enforcer | menace | Aggro rare |
| yn-yurei-backup-singer | Yurei Backup Singer | R | U/B | Creature | Ghost idol | skyborne, drain | Evasive value |
| yn-shrineware-sentinel | Shrineware Sentinel | R | W | Artifact Creature | Shrine robot | sentinel | Artifact body |
| yn-hannya-mask-rig | Hannya Mask Rig | R | C | Artifact Equipment | Demon mask | equip, menace grant | Aggro gear |
| yn-tengu-wingboard | Tengu Wingboard | R | U | Artifact Equipment | Hoverboard | equip, skyborne grant | Evasion gear |
| yn-foxfire-pulse | Foxfire Pulse | R | U/R | Charm | Kitsune code spell | modal damage/scry/recall | Flexible interaction |
| yn-black-rain-contract | Black Rain Contract | R | B | Ritual | Underworld deal | modal draw/discard/drain | Black modal |
| yn-miko-hard-reset | Miko Hard Reset | R | W/U | Charm | Shrine countermeasure | modal protect/tap/exile artifact | Control spell |
| yn-spiderweb-protocol | Spiderweb Protocol | R | U/B | Enchantment | Jorogumo trap | tap equipped creature, scry | Control engine |
| yn-ronin-of-red-lanterns | Ronin of Red Lanterns | R | R | Creature | Street samurai | firstBlade, equipment bonus | Equipment attacker |
| yn-cat-ear-debugger | Cat-Ear Debugger | R | U | Creature | Nekomata tech | draw on modal cast | Spells payoff |
| yn-cyber-kappa-bouncer | Cyber-Kappa Bouncer | R | G/U | Creature | Kappa guard | bulwark, recall | Tempo blocker |
| yn-dragonline-implant | Dragonline Implant | R | G/R | Artifact Equipment | Spirit implant | equip, overrun | Green/red gear |
| yn-lantern-daemon | Lantern Daemon | R | B | Artifact Creature | Possessed lantern | skyborne, drain | Artifact threat |
| yn-ward-paper-printer | Ward-Paper Printer | R | W | Artifact | Shrine printer | createToken, protect | Token relic |
| yn-neon-suture-kit | Neon Suture Kit | R | W/B | Artifact Equipment | Street medic gear | equip, bloodoath | Lifegain equipment |
| yn-rain-alley-ambush | Rain-Alley Ambush | R | B/R | Charm | Alley attack | modal damage/menace | Combat removal |
| yn-cloud-server-tengu | Cloud-Server Tengu | R | U | Creature | Tengu sysadmin | skyborne, modal discount | Blue rare |
...
| yn-shrine-roomba | Shrine Roomba | C | C | Artifact Creature | Shrine bot | bulwark | Artifact common |
| yn-tengu-courier | Tengu Courier | C | U | Creature | Tengu messenger | skyborne | Blue flyer |
| yn-kappa-firewall | Kappa Firewall | C | G/U | Creature | Kappa defender | bulwark, wardingGaze | Defensive common |
| yn-neko-street-doc | Neko Street Doc | C | W/B | Creature | Nekomata medic | bloodoath | Lifegain common |
| yn-holo-talisman | Holo Talisman | C | C | Artifact Equipment | Digital charm | equip, +1/+1 | Basic gear |
| yn-rain-slick-blade | Rain-Slick Blade | C | C | Artifact Equipment | Street blade | equip, deathblade small | Removal gear |
| yn-foxfire-cantrip | Foxfire Cantrip | C | U/R | Charm | Code spark | modal scry/damage 1 | Common modal |
| yn-neon-uppercut | Neon Uppercut | C | R | Charm | Oni punch | boost/damage | Combat trick |
| yn-ward-flash | Ward Flash | C | W | Charm | Shrine ward | protect/equip response | White trick |
| yn-black-ice | Black Ice | C | U/B | Ritual | Hack attack | tap, discard | Control common |
...
| yn-tattooed-ronin | Tattooed Ronin | C | R | Creature | Street ronin | firstBlade | Combat common |
...
| yn-rooftop-prayer | Rooftop Prayer | C | W/U | Charm | Neon shrine prayer | modal gain/tap | Control trick |
...
| yn-overclocked-moped | Overclocked Moped | C | C | Artifact Equipment | Bike gear | equip, warcry grant | Red gear |
| yn-shrine-token-printer | Shrine Token Printer | C | W | Artifact | Token machine | createToken | White artifact |
| yn-graffiti-sigil | Graffiti Sigil | C | R | Enchantment | Street ward | attacker boost | Red support |
| yn-moss-circuit-tanuki | Moss-Circuit Tanuki | C | G | Creature | Tanuki tech | manaAbility | Ramp common |
| yn-umbra-headphones | Umbra Headphones | C | C | Artifact Equipment | Idol gear | equip, bloodoath if black | Utility gear |
| yn-drone-scout | Drone Scout | C | C | Artifact Creature | Surveillance drone | skyborne | Artifact flyer |
| yn-elevator-to-nowhere | Elevator to Nowhere | C | U | Charm | Weird tech | recall | Blue interaction |
| yn-redline-download | Redline Download | C | R/U | Ritual | Fast hack | draw discard, damage self | Spells common |

## Precon Identity

**Neon Arsenal** - U/R equipment-tempo. The deck uses cheap equipment, evasive carriers, modal interaction, and warcry pressure.
