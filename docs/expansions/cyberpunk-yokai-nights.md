<!-- source-of-truth: src/engine/types.ts · last-verified: 2026-07-10 · concept doc — future expansion, not implemented (planned src/data/cards/cyberpunk-yokai-nights.ts); anti-rot anchors on the Keyword/EffectOp vocabulary the card tables must stay legal against -->
