...
| gm-moor-path | Moorlight Lantern | C | B | Artifact | Foggy road | {T}, {3}: Your opponent loses 2 life, then you gain 2 life. | Common Duty artifact |
| gm-chapel-yard | Chapel-Yard Rosary | C | W | Artifact | Grave chapel | {T}: Sever the top card of your opponent's graveyard. | Common Duty artifact |
| gm-lab-annex | Annex Notebook | C | U | Artifact | Storm lab | {T}: Foresee 1. | Common Duty artifact |
| gm-red-roof-village | Festival Rocket | C | R | Artifact | Gothic village | {T}, {2}: Deal 2 damage to target creature. | Common Duty artifact |
| gm-thorned-cemetery | Cemetery Thorn | C | G | Artifact | Grave garden | {T}: Put the top card of your deck into your graveyard. | Common Duty artifact |
