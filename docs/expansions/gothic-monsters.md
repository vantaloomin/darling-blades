...
| gm-moor-path | Moorlight Lantern | C | B | Artifact | Foggy road | {3}, {T}: Your opponent loses 2 life, then you gain 2 life. | Common Duty artifact |
...
| gm-red-roof-village | Festival Rocket | C | R | Artifact | Gothic village | {2}, {T}: Deal 2 damage to target creature. | Common Duty artifact |
