<!-- Source of truth placeholder: future src/data/cards/celtic-fae.ts - design draft, not implemented - last-verified: 2026-07-05 -->
...
Celtic Fae is a silver-green twilight set built around fae courts, war omens, selkies, banshees, sidhe duelists, old hill gates, moonlit bogs, and impossible bargains. The set should feel elegant, dangerous, and transactional: every gift has a hook.

Visual anchors: silver moonlight, moss green, blackthorn, mist, pale gold torcs, raven feathers, glassy pools, mushroom rings, thorn crowns, and hollow hills. All characters are adult-coded.

## Mechanic Summary

- **Exile**: banishment, temporary removal, graveyard hate, and "lost beyond the veil" effects.
- **Scry**: fate-reading, omen setup, and consistency for slower control shells.
- Primary colors: U/B/G, with W fae knights and R wild hunt pressure.
- Mechanical identity: tempo-control, topdeck control, evasive fae, exile-based answers, and scry payoff cards.
...
| cf-balor-evil-eye | Balor's Evil Eye | SSR | B/R | Sorcery | Fomorian curse | damage, exile if dies | Premium removal |
| cf-wild-hunt-matriarch | Wild Hunt Matriarch | SSR | R/G | Legendary Creature | Hunt leader | haste, trample, scry on attack | Aggro boss card |
| cf-cauldron-of-dagda | Cauldron of the Dagda | SSR | G | Artifact | Mythic cauldron | reanimate-lite from exile? gainLife | Big value relic |
| cf-bean-sidhe-keening | Bean Sidhe Keening | SR | B | Creature | Banshee | flying, mill/exile grave, loseLife | Grave hate threat |
| cf-silver-branch-oracle | Silver Branch Oracle | SR | U | Creature | Fae seer | scry 2, draw | Blue value creature |
| cf-thorn-crown-geas | Thorn-Crown Geas | SR | G | Enchantment | Fae bargain | static pump, exile clause | Build-around aura |
| cf-glamour-of-the-hill | Glamour of the Hollow Hill | SR | U | Instant | Illusion glamour | scry, bounce, exile token | Defensive trick |
| cf-redcap-blood-host | Redcap Blood-Host | SR | R/B | Creature | Redcap warband | haste, menace-like pressure | Aggro bridge |
...
| cf-dance-under-mound | Dance Under the Mound | R | U/G | Sorcery | Fae revel | createToken, scry | Token setup |
...
| cf-fae-ring-initiate | Fae-Ring Initiate | C | U | Creature | Novice fae adept | scry 1 ETB | Common setup |
| cf-mistwing-pixie | Mistwing Pixie | C | U | Creature | Pixie scout | flying | Evasive common |
| cf-thorn-sprite | Thorn Sprite | C | G | Creature | Forest sprite | reach | Green common |
| cf-redcap-skirmisher | Redcap Skirmisher | C | R | Creature | Redcap attacker | haste | Aggro common |
| cf-bog-banshee | Bog Banshee | C | B | Creature | Banshee | menace-like cannot be blocked by small? | Black attacker |
| cf-sidhe-page | Sidhe Page | C | W | Creature | Fae attendant | vigilance | White filler |
| cf-omen-raven | Omen Raven | C | B | Creature | Raven familiar | flying, scry on ETB | Black flyer |
| cf-selkie-runner | Selkie Runner | C | U | Creature | Selkie messenger | scry on combat damage | Tempo common |
| cf-mushroom-ring-guard | Mushroom-Ring Guard | C | G | Creature | Fae guard | defender | Defensive common |
...
| cf-fade-beyond-veil | Fade Beyond the Veil | C | W | Instant | Veil banishment | temporary exile attacker | Combat answer |
| cf-barrow-whisper | Barrow Whisper | C | B | Sorcery | Dead counsel | scry, mill self | Grave setup |
| cf-thornsnare | Thornsnare | C | G | Instant | Briar trap | pump, reach | Combat trick |
| cf-ember-of-brigid | Ember of Brigid | C | R | Instant | Sacred flame | damage 2 | Red removal |
| cf-bargain-for-time | Bargain for Time | C | U | Sorcery | Time bargain | draw, scry | Blue cantrip |
...
| cf-night-market-bargain | Night-Market Bargain | C | B | Sorcery | Fae market | draw, loseLife | Black draw |
| cf-laughing-pooka | Laughing Pooka | C | R/G | Creature | Pooka trickster | haste | Hybrid pressure |
| cf-hazelwand-mystic | Hazelwand Mystic | C | G | Creature | Druidic fae | manaAbility G | Ramp common |
| cf-clouded-memory | Clouded Memory | C | U | Instant | Memory glamour | bounce, scry | Tempo spell |
| cf-bitter-geas | Bitter Geas | C | B | Enchantment Aura | Compulsion curse | attached -1/-1 | Black debuff |
| cf-hill-feast | Hill Feast | C | G | Sorcery | Otherworld feast | gainLife, createToken | Green value |
| cf-silver-apple-shot | Silver Apple Shot | C | R | Sorcery | Magic projectile | damage 3 to creature | Red common removal |
| cf-oak-shield-vow | Oak-Shield Vow | C | W | Instant | Defensive oath | pump toughness, scry | White trick |
| cf-fogbell-chime | Fogbell Chime | C | U | Artifact | Mist charm | tap creature | Blue utility |
| cf-moorland-guide | Moorland Guide | C | W/G | Creature | Border guide | vigilance | Block bridge common |
| cf-veil-touched-hart | Veil-Touched Hart | C | G | Creature | Otherworld deer | scry ETB | Green setup |
| cf-cairnlight-adept | Cairnlight Adept | C | B | Creature | Cairn witch | mill self | Grave setup |
| cf-fae-spark | Fae Spark | C | R | Instant | Wild glamour | pump + damage to controller | Red trick |

## Precon Identity

**Glimmer Bargain** - U/B/G tempo-control. The deck plays evasive fae, scry smoothing, selective exile answers, and value creatures that turn topdeck control into steady pressure.
...
- Keep all fae adult-coded and regal rather than childlike.
- Avoid readable ogham, runes, or text on stones, banners, cards, mirrors, and books.
- Establish a consistent fae silhouette language: elongated cloaks, thorn crowns, silver jewelry, moonlit eyes, and nature-integrated armor.
- Celtic + Arthurian should share visual DNA but differ in texture: fae = mist/silver/thorn; Arthurian = steel/grail/banner/castle.
