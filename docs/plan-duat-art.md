<!-- source-of-truth: docs/art-bible/index.md, docs/art-bible/sands-of-the-duat-drafts.md, docs/spell-art.md, docs/plan-duat-creative.md, docs/plan-1.6-large-set.md, scripts/gen-card-art.ts, scripts/gen-spell-art.ts, scripts/check-art-bible.ts, scripts/gen-art-halfres.ts, src/scenes/ShopScene.ts · last-verified: 2026-08-21 · program doc — the Sands of the Duat art production plan; re-verify when the pipeline scripts or the card-data waves change -->
...
## 7. Wave E prompt-surgery addenda (2026-08-21)

### Owner rulings (binding)

- **ANKH, owner-ruled 2026-08-21:** An ankh-headed staff held by the figure is allowed only where the entry briefs it. Ankhs never appear as unbriefed props, ornaments, wall or floor inlays, or decoration. Keeper of the Last Mark keeps her held staff; every touched entry without that brief carries "no ankh-shaped objects, no ankh ornaments, no ankh inlays". Keeper of the Long Debt loses her unbriefed staff, and Bastet Gate-Chorus loses its floor ankh and starburst.
- **SKYBORNE, owner-ruled 2026-08-21:** The lenient ruling accepts "no ground under her"; visible feet over open air are not required. Regen is limited to the ten clearly grounded skyborne cards. Their replacement clause is "hovering in open air with clear sky and the lapis channel visible beneath her, no ground, deck, terrace, pier, rail, prow, or marker under her", plus a named negative for the support previously mentioned. Ra, Helm of the Night Barge remains the recorded skyborne exception.
- **Extended breach guard, owner-ruled 2026-08-21:** Egyptian pictographs and determinative marks, non-Egyptian architecture and props including domes, rotundas, Greco-Roman colonnades/cornices/dentils/entablatures/classical facades, striped awnings, Christian crosses/cross finials, coronets, heraldic escutcheons of any shape, ship's wheels, modern lamps/crystals/salt lamps, jackal-headed colossi and male statues are banned.

### Rules 22-29

22. **SKYBORNE NEEDS A NAMED NEGATIVE.** Use the owner ruling above on every touched skyborne entry. **Evidence:** 10 of 18 skyborne reads were grounded, and the hovering clause alone lost to a named rail.
23. **BLUE-EYED BASTET LOSE THE SLIT.** Every touched Bastet with lapis, blue, or green irises uses "amber-gold irises with narrow cat-slit vertical pupils, never round pupils", led by "Cat-slit narrow vertical pupils." and carrying "no round pupils" in negatives. Character and Expression fields agree. **Evidence:** Eleven Bastet renders had round pupils; nearly all lapis/blue/green-eyed Bastet renders were blue-eyed, while every amber-eyed Bastet held a slit.
24. **FRAMED BLANK RECTANGLES RENDER AS SIGNS.** Never describe a panel, plaque, tablet, leaf, case, seal, standard head, or page as blank, empty, or framed in a generation Prompt. Hero props use "flat lapis-and-gold geometric banded" objects. The positive cartouche phrase is "flush wall inlays of flat lapis-and-gold geometric banding"; negatives include "no signboards, no placards, no hanging signs, no billboards on posts, no blank framed rectangles, no empty plaques, no label plates, no nameplates". **Evidence:** 31 images showed blank placards/signboards, including four hero props.
25. **RED IDENTITY IS BARGE FIRE, NOT RED CLOTH.** R costumes use barge-fire orange and tomb-gold linen, natron white, and bronze; red identity lives in fire and ember light only. Add "no red cloth, no crimson fabric, no brick-red bodice, skirt, veil, sash, banner, or column capital". Heart-red #c8253a remains reserved and unchanged. **Evidence:** 11 R-identity images carried brick-red or vermilion cloth or architecture fields.
26. **NON-EGYPTIAN VOCABULARY, EXTENDED LIST.** Every touched Prompt carries the extended guard: no domes, rotundas, Greco-Roman colonnades, cornices, dentils, entablatures, classical facades, striped awnings, Christian crosses or cross-shaped finials, coronets, heraldic escutcheons of any shape, ship's wheels, modern lamps, crystals, salt lamps, pictographs, determinative marks, winged sun discs, jackal-headed colossi or statues, male statues, or male figures. **Evidence:** the sweep found the extra-breach list beyond the older shield, key-border, ship, and jar vocabulary.
27. **ANKH RULING.** Every touched Prompt without a specifically briefed held ankh staff carries "no ankh-shaped objects, no ankh ornaments, no ankh inlays"; no ankh is an unbriefed prop, ornament, wall or floor inlay, or decoration. **Evidence:** Keeper of the Long Debt had an unbriefed staff and Bastet Gate-Chorus had a floor ankh inlay.
28. **ONE-CHARACTER RETROFIT.** Every touched creature entry positively briefs "EXACTLY ONE adult woman in the entire image and not one person more", with the Preserve after-image as HER OWN half-overlapping translucent natron-white silhouette and Rite allowing only the disembodied hand exception. Add "no second figure, no other person, no statues of people". Re-stage choruses and formations as one woman plus environment. **Evidence:** Nefru and Tiaa still briefed four women, while Ammit, Channel Archive Keeper, and others rendered a second woman.
29. **NAMED KEYS AND MECHANIC EVIDENCE AT MID-BAND, RESTATED.** Put "at mid-height inside the central band" immediately after every named key or mechanic-evidence noun; held props are at chest height, the entire object above the figure's waistline and below her chin. The four rule-20 cards use directional, off-centre effects with the full anti-burst negatives. **Evidence:** six practical keys and several life marks, landing traces, and offerings rendered outside y167-633 despite the existing rule-17 qualifier.

### Prompt guard addenda

Every touched Prompt carries the extended blank-cartouche positive, smooth plain geometric architecture with no recessed relief panels or sunken cartouche outlines, the non-Egyptian vocabulary and ankh guards, the named skyborne negative when applicable, the one-character count on creature entries, the red-identity guard on R cards, and "no lens flare, no starburst, no radial rays, no glowing orb, no light burst" for directional-effect cards.
