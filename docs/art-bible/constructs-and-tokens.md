...
- **Prompt:** Fist-sized lapis-and-gold scarab beetle carrying a tiny sealed offering bead through a Duat tomb, tomb-gold shell segments and crisp lapis wing cases, six legs and feelers clearly separated in a readable side-on three-quarter stance, resin-brown sandstone floor with lapis inlay, small gold brazier inside the frame as practical key and one lapis-cool floor rim, blank gold cartouche panels, geometric banded registers, NO-TEXT, no hieroglyphs, no glyphs, no writing, no inscriptions, no heart-red, no true black, darkest visible value resin brown `#3a2a1c`, central-band composition with generous surrounding bleed, wholly non-humanoid beetle silhouette — crisp cel-shaded gacha anime splash art, fully rendered scenic background, 640×800 portrait
...
- **Prompt:** Child-proportioned cub-like Bastet cat-kit in miniature natron-white wrappings with lapis-and-tomb-gold trim, two upright tufted ears, exactly ONE unforked tail with one tip emerging from the base of the spine at the tailbone, slit pupils, rounded child-coded limbs and a curious closed-mouth expression, crouched at a white sandstone Lion Gate with one paw lifted, wholly non-sexualized and not an adult woman, small gold gate lamp inside the frame as practical key and one lapis-cool inlay rim, blank gold cartouche panels, geometric banded registers, NO-TEXT, no hieroglyphs, no glyphs, no writing, no inscriptions, no heart-red, no extra tail, no true black, darkest visible value resin brown `#3a2a1c`, generous headroom and a clear central-band figure — crisp cel-shaded gacha anime splash art, fully rendered scenic background, 640×800 portrait
