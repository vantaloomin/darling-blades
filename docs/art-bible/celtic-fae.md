<!-- source-of-truth: src/data/cards/celtic-fae.ts · last-verified: 2026-07-10 -->
...
- **Costume & attire:** a blackthorn crown, layered raven-feather mantle, fitted black-green nature-forged armor, and a pale gold torc.
- **Palette:** gold multicolor palette (`#e8c95a` → `#7a5a18`, accent `#fff2b8`) — pale gold torcs, silver moonlight, and courtly green-black depth; Celtic Fae accents — silver moonlight, moss green, blackthorn, raven black, glassy water, and pale gold torcs — layer over the color anchor without replacing it.
- **Lighting:** hard silver moonlight from upper left as key; green-black aurora rim along feathers and armor.
- **Expression:** regal, pitiless, and almost amused by the bargain already broken.
- **Props / weapon:** a raven perched on her wrist and a spear whose leaf-shaped blade catches a cold star.
- **Background:** a glassy battlefield pool beneath a silver moon, treaty ribbons torn blank in the reeds.
- **Holo interaction:** Rolled specials favor otherworldly aurora; concentrate reflective texture in silver torcs, dew, wet leaves, and thorn-metal while the face remains calm.
- **Rarity ambition:** Marquee sovereign — the full fae-court key visual: a singular regal silhouette, a secondary symbol, and a landscape with consequences.
...
- **Card facts:** {3}{U}{G} · U/G (gold frame) · 4/4 · untouchable · ur, legendary · holo: otherworldly aurora
...
- **Costume & attire:** an elongated silver-edged cloak, thorn crown, moonstone jewelry, and bark-and-leaf armor worked like formal regalia.
- **Palette:** gold multicolor palette (`#e8c95a` → `#7a5a18`, accent `#fff2b8`) — pale gold torcs, silver moonlight, and courtly green-black depth; Celtic Fae accents — silver moonlight, moss green, blackthorn, raven black, glassy water, and pale gold torcs — layer over the color anchor without replacing it.
- **Lighting:** soft silver moon key from high left; saturated moss-green rim separating cloak from the hill-dark.
- **Expression:** perfectly composed, warm enough to invite trust and cold enough to punish it.
- **Props / weapon:** a pale gold torc, a branch sceptre, and drifting moth-like lights.
...
- **Costume & attire:** sun-pale layered silk beneath nature-integrated gold-and-leaf armor, a thorn-and-apple crown, and bright silver jewelry.
- **Palette:** gold multicolor palette (`#e8c95a` → `#7a5a18`, accent `#fff2b8`) — pale gold torcs, silver moonlight, and courtly green-black depth; Celtic Fae accents — silver moonlight, moss green, blackthorn, raven black, glassy water, and pale gold torcs — layer over the color anchor without replacing it.
- **Lighting:** warm low sun as the key; cool silver moon rim across the crown and shoulder.
- **Expression:** radiant, patient, and dangerously sincere.
- **Props / weapon:** a luminous apple in an open palm and a pale gold torc half-hidden by flowering vines.
...
- **Costume & attire:** a long blue-white cloak with silver thread embroidery, slim nature-shaped bracers, a thorn circlet, and moonlit eyes.
- **Palette:** gold multicolor palette (`#e8c95a` → `#7a5a18`, accent `#fff2b8`) — pale gold torcs, silver moonlight, and courtly green-black depth; Celtic Fae accents — silver moonlight, moss green, blackthorn, raven black, glassy water, and pale gold torcs — layer over the color anchor without replacing it.
- **Lighting:** cool lake reflection as key from below-left; clean silver rim from the moon behind her.
- **Expression:** calm, observant, and already aware of the promise the viewer will regret.
- **Props / weapon:** a glassy water mirror, a willow wand, and blank stone tablets with only non-textural weathering.
...
- **Costume & attire:** a seal-skin mantle worn over a fitted teal-and-silver court gown, shell clasps, a fine torc, and wet moonlit hair.
- **Palette:** gold multicolor palette (`#e8c95a` → `#7a5a18`, accent `#fff2b8`) — pale gold torcs, silver moonlight, and courtly green-black depth; Celtic Fae accents — silver moonlight, moss green, blackthorn, raven black, glassy water, and pale gold torcs — layer over the color anchor without replacing it.
- **Lighting:** moon reflection on the water as a blue-silver key; deep green sea-glow as the rim.
- **Expression:** unhurried, elusive, and delighted to know more than she says.
- **Props / weapon:** a silver comb, pearl-bright droplets, and a folded seal pelt with a clear readable silhouette.
- **Background:** a black-glass tidal pool ringed by kelp, moonlit rocks, and a distant hollow-hill door.
- **Holo interaction:** Rolled specials favor prismatic moonfoil; concentrate reflective texture in silver torcs, dew, wet leaves, and thorn-metal while the face remains calm.
- **Rarity ambition:** Legendary splash — a commanding court scene where the Otherworld itself participates in the composition.
...
- **Costume & attire:** blackthorn-and-antler crown, hunting cloak elongated into a banner shape, moss-dark armor, and pale gold bridle jewelry.
- **Palette:** gold multicolor palette (`#e8c95a` → `#7a5a18`, accent `#fff2b8`) — pale gold torcs, silver moonlight, and courtly green-black depth; Celtic Fae accents — silver moonlight, moss green, blackthorn, raven black, glassy water, and pale gold torcs — layer over the color anchor without replacing it.
- **Lighting:** cold silver moon key on the face and weapon; hot foxfire rim from the passing hunt.
- **Expression:** exultant, authoritative, and certain the quarry is already hers.
- **Props / weapon:** a crescent hunting horn, a leaf-bladed spear, and spectral hounds held as secondary silhouettes.
...
- **Costume & attire:** a torn but regal mist-grey mourning cloak, thorn-silver hair ornaments, and nature-etched black armor at the shoulders.
- **Palette:** B palette (`#5a3a70` → `#140d1c`, accent `#9b6fc4`) — blackthorn violet, raven-black, and grave-lilac; Celtic Fae accents — silver moonlight, moss green, blackthorn, raven black, glassy water, and pale gold torcs — layer over the color anchor without replacing it.
- **Lighting:** lilac bog-glow as key from below; sharp moon-silver rim around the veiling hair.
- **Expression:** funereal, intimate, and mercilessly patient.
- **Props / weapon:** a silver keening bell and shredded veil streamers that remain blank and non-lettered.
- **Background:** a bog-side cairn field with low mist, raven feathers, and one distant hollow-hill light.
- **Holo interaction:** Rolled specials favor radiant foil; concentrate reflective texture in silver torcs, dew, wet leaves, and thorn-metal while the face remains calm.
- **Rarity ambition:** Rare moment — an elegant magical turning point, with mist, water, or thornwork actively framing the figure.
- **Prompt:** Bean Sidhe Keening, an adult banshee of the old courts, beautiful and ruinously composed, wearing a torn but regal mist-grey mourning cloak, thorn-silver hair ornaments, and nature-etched black armor at the shoulders; floating forward with one hand near her throat, cloak and hair rising in the note she has not yet released; funereal, intimate, and mercilessly patient; against a bog-side cairn field with low mist, raven feathers, and one distant hollow-hill light; lilac bog-glow as key from below; sharp moon-silver rim around the veiling hair; reserve the entire top third as clear, empty moonlit mist or sky above the head, thorn crown, and antlers so no crown clips; no readable ogham, runes, letters, banners, cards, mirrors, or text anywhere — crisp cel-shaded gacha anime splash art, fully rendered scenic background, 640×800 portrait

### Silver-Branch Oracle — `cf-silver-branch-oracle`
- **Card facts:** {3}{U} · U · 2/4 · sr · holo: radiant foil
- **Character & source:** an adult fae oracle who reads fate from living wood and reflected water; mechanically a reader and arranger of fate.
- **Personality / mood:** “The branch points to every future. She charges by the direction.” — serene, businesslike, and faintly amused by mortal certainty.
- **Pose & composition:** seated upright beside the pool, branch pointing through the frame while her gaze stays centered; face ≈ y 320 and eye-line ≈ y 300–360. The entire top third stays clear empty sky or mist above the head, crown, antlers, and hair for crop-safe headroom.
- **Costume & attire:** a long moss-and-silver mantle, thorn circlet, layered beadwork, and lacquered leaf armor at the wrists.
- **Palette:** U palette (`#4a90d9` → `#16294f`, accent `#a8d4f7`) — deep pool-blue, silver mist, and cold moonlight; Celtic Fae accents — silver moonlight, moss green, blackthorn, raven black, glassy water, and pale gold torcs — layer over the color anchor without replacing it.
- **Lighting:** pool-light key across the face; cool moon rim tracing the branch and cloak edge.
- **Expression:** serene, businesslike, and faintly amused by mortal certainty.
- **Props / weapon:** a forked silver branch, a shallow scrying bowl, and floating leaf motes.
...
- **Costume & attire:** a crimson cap over a thorn crownlet, short blackthorn cloak, layered peat-black armor, and silver rings.
- **Palette:** R palette (`#d95436` → `#5e0f0f`, accent `#f7b267`) — foxfire ember, blood-red, and warm peat; Celtic Fae accents — silver moonlight, moss green, blackthorn, raven black, glassy water, and pale gold torcs — layer over the color anchor without replacing it.
- **Lighting:** warm foxfire key across the cap and weapon; hard violet moon rim on the moving silhouette.
- **Expression:** reckless, courtly in the worst possible way, and laughing through clenched teeth.
- **Props / weapon:** a hooked sickle, a small round buckler, and a single redcap banner rendered blank.
...
### Mab, Midnight Queen — `cf-queen-mab-midnight`
...
- **Holo interaction:** Rolled specials favor radiant foil; concentrate reflective texture in silver torcs, dew, wet leaves, and thorn-metal while the face remains calm.
- **Rarity ambition:** Rare moment — an elegant magical turning point, with mist, water, or thornwork actively framing the figure.
- **Prompt:** Mab, Midnight Queen, an adult fae queen, sovereign of a beautiful court that is quietly dangerous, wearing an elongated silver-edged cloak, thorn crown, moonstone jewelry, and bark-and-leaf armor worked like formal regalia; seated or standing in absolute stillness, one hand extended as if granting a gift with a hidden hook; perfectly composed, warm enough to invite trust and cold enough to punish it; against a hollow-hill audience chamber opening through mist onto a moonlit forest; soft silver moon key from high left; saturated moss-green rim separating cloak from the hill-dark; the very top of her head and thorn crown sits clearly below the top-third line — the entire top third is nothing but clear empty moonlit mist, generous open space above the crown so nothing clips; no readable ogham, runes, letters, banners, cards, mirrors, or text anywhere — crisp cel-shaded gacha anime splash art, fully rendered scenic background, 640×800 portrait

### Hollow-Hill Gatekeeper — `cf-hollow-hill-gatekeeper`
- **Card facts:** {2}{U} · U · 2/5 · bulwark · r · holo: shiny
- **Character & source:** an adult fae gatekeeper, a court sentinel whose welcome is a test; mechanically a steadfast boundary keeper, a reader and arranger of fate.
- **Personality / mood:** “She asks where you are going. The wrong answer is any answer.” — formally courteous, immovable, and impossible to hurry.
- **Pose & composition:** front-facing and planted, spear vertical at one side while the shield catches the visible band; face ≈ y 320 and eye-line ≈ y 300–360. The entire top third stays clear empty sky or mist above the head, crown, antlers, and hair for crop-safe headroom.
- **Costume & attire:** a columnar blue-silver cloak, thorn crown, bark-lamellar armor, and an engraved-looking but textless torc.
- **Palette:** U palette (`#4a90d9` → `#16294f`, accent `#a8d4f7`) — deep pool-blue, silver mist, and cold moonlight; Celtic Fae accents — silver moonlight, moss green, blackthorn, raven black, glassy water, and pale gold torcs — layer over the color anchor without replacing it.
- **Lighting:** cool interior hill-light as key; moonlit silver rim on the spear and crown.
- **Expression:** formally courteous, immovable, and impossible to hurry.
- **Props / weapon:** a tall silver spear, a round mirror shield, and a gate of blackthorn branches.
- **Background:** the threshold of a hollow hill, mist spilling over a moonlit stone stair.
- **Holo interaction:** Rolled specials favor shiny; concentrate reflective texture in silver torcs, dew, wet leaves, and thorn-metal while the face remains calm.
...
- **Costume & attire:** a close-fitted green-black dueling coat under an elongated split cloak, thorn crown, silver jewelry, and leaf-steel vambraces.
- **Palette:** G palette (`#4fa06a` → `#123a22`, accent `#a9dcae`) — moss green, wet leaf shadow, and luminous verdigris; Celtic Fae accents — silver moonlight, moss green, blackthorn, raven black, glassy water, and pale gold torcs — layer over the color anchor without replacing it.
- **Lighting:** clean moon-silver key on the blade side; lush moss-green rim along cloak and boots.
- **Expression:** precise, proud, and too polite to call the first strike a threat.
- **Props / weapon:** a narrow leaf-shaped dueling sword and a pale gold torc at the throat.
- **Background:** a blackthorn avenue beside a moonlit pool, fallen white petals caught in the sword wind.
- **Holo interaction:** Rolled specials favor shiny; concentrate reflective texture in silver torcs, dew, wet leaves, and thorn-metal while the face remains calm.
- **Rarity ambition:** Uncommon — a decisive courtly action plus one environmental story beat, without losing the silhouette at battlefield scale.
- **Prompt:** Blackthorn Duelist, an adult Sidhe blade dancer of the silver court, wearing a close-fitted green-black dueling coat under an elongated split cloak, thorn crown, silver jewelry, and leaf-steel vambraces; three-quarter lunge, blade leading across the middle band while the cloak counter-sweeps behind; precise, proud, and too polite to call the first strike a threat; against a blackthorn avenue beside a moonlit pool, fallen white petals caught in the sword wind; clean moon-silver key on the blade side; lush moss-green rim along cloak and boots; reserve the entire top third as clear, empty moonlit mist or sky above the head, thorn crown, and antlers so no crown clips; no readable ogham, runes, letters, banners, cards, mirrors, or text anywhere — crisp cel-shaded gacha anime splash art, fully rendered scenic background, 640×800 portrait

### Raven-Torc Envoy — `cf-raven-torc-envoy`
- **Card facts:** {2}{B} · B · 2/3 · skyborne · r · holo: shiny
- **Character & source:** an adult raven-aspected fae envoy, not a childlike bird mascot; mechanically an airborne omen and evasive threat, a keeper of the veil between worlds.
- **Personality / mood:** “She brings a silver ring and takes a name from the dead.” — watchful, formal, and carrying news nobody will enjoy.
...
- **Costume & attire:** a feathered black cloak over slim court armor, a thorn tiara, silver rings, and a pale gold raven torc.
- **Palette:** B palette (`#5a3a70` → `#140d1c`, accent `#9b6fc4`) — blackthorn violet, raven-black, and grave-lilac; Celtic Fae accents — silver moonlight, moss green, blackthorn, raven black, glassy water, and pale gold torcs — layer over the color anchor without replacing it.
- **Lighting:** overcast moon key across the face; violet-black feather rim from the fog behind.
- **Expression:** watchful, formal, and carrying news nobody will enjoy.
- **Props / weapon:** a blank silver signet ring, feather fan, and one black wing spread as a silhouette accent.
- **Background:** a cairn-lined moor with a murder of ravens circling through silver fog.
- **Holo interaction:** Rolled specials favor shiny; concentrate reflective texture in silver torcs, dew, wet leaves, and thorn-metal while the face remains calm.
- **Rarity ambition:** Uncommon — a decisive courtly action plus one environmental story beat, without losing the silhouette at battlefield scale.
- **Prompt:** Raven-Torc Envoy, an adult raven-aspected fae envoy, not a childlike bird mascot, wearing a feathered black cloak over slim court armor, a thorn tiara, silver rings, and a pale gold raven torc; landing or stepping from a low rock with the cloak opening like folded wings; watchful, formal, and carrying news nobody will enjoy; against a cairn-lined moor with a murder of ravens circling through silver fog; overcast moon key across the face; violet-black feather rim from the fog behind; reserve the entire top third as clear, empty moonlit mist or sky above the head, thorn crown, and antlers so no crown clips; no readable ogham, runes, letters, banners, cards, mirrors, or text anywhere — crisp cel-shaded gacha anime splash art, fully rendered scenic background, 640×800 portrait

### Moon-Pool Selkie — `cf-moon-pool-selkie`
- **Card facts:** {2}{U} · U · 2/3 · r · holo: shiny
- **Character & source:** an adult selkie courtier, elegant in both sea and shore forms; mechanically a reader and arranger of fate.
- **Personality / mood:** “She slips below the surface whenever the conversation turns honest.” — unhurried, elusive, and delighted to know more than she says.
- **Pose & composition:** rising from the pool at a three-quarter turn, one hand skimming water into a bright arc; face ≈ y 320 and eye-line ≈ y 300–360. The entire top third stays clear empty sky or mist above the head, crown, antlers, and hair for crop-safe headroom.
- **Costume & attire:** a seal-skin mantle worn over a fitted teal-and-silver court gown, shell clasps, a fine torc, and wet moonlit hair.
- **Palette:** U palette (`#4a90d9` → `#16294f`, accent `#a8d4f7`) — deep pool-blue, silver mist, and cold moonlight; Celtic Fae accents — silver moonlight, moss green, blackthorn, raven black, glassy water, and pale gold torcs — layer over the color anchor without replacing it.
- **Lighting:** moon reflection on the water as a blue-silver key; deep green sea-glow as the rim.
...
- **Costume & attire:** a narrow pale-gold collar, blackthorn charms, and mossy spectral fur that integrates with the surrounding roots.
- **Palette:** G palette (`#4fa06a` → `#123a22`, accent `#a9dcae`) — moss green, wet leaf shadow, and luminous verdigris; Celtic Fae accents — silver moonlight, moss green, blackthorn, raven black, glassy water, and pale gold torcs — layer over the color anchor without replacing it.
- **Lighting:** cold moon key on the muzzle and shoulders; sickly green hill-light rim along the fur.
- **Expression:** silent, inexorable, and already on the scent of a broken promise.
- **Props / weapon:** a silver leash trailing loose, white breath, and thorn vines swept back by the charge.
...
- **Costume & attire:** nature-integrated plate with leaf edges, a long pale cloak, thorn crown under a helm circlet, and a pale gold torc.
- **Palette:** W palette (`#f2e8cf` → `#c9a84c`, accent `#fffef2`) — pearl-white, pale gold, and moonlit ivory; Celtic Fae accents — silver moonlight, moss green, blackthorn, raven black, glassy water, and pale gold torcs — layer over the color anchor without replacing it.
- **Lighting:** pearl moon key on the armor planes; saturated green rim along cloak and shield.
- **Expression:** chivalric, reserved, and wholly committed to a vow that predates the visitor.
- **Props / weapon:** a silver lance or leaf-bladed sword, a round oak shield, and no heraldic text.
- **Background:** a moonlit knoll above a misty court-road, oak roots twisting through old stone.
- **Holo interaction:** Rolled specials favor shiny; concentrate reflective texture in silver torcs, dew, wet leaves, and thorn-metal while the face remains calm.
- **Rarity ambition:** Uncommon — a decisive courtly action plus one environmental story beat, without losing the silhouette at battlefield scale.
- **Prompt:** Sidhe Silver-Lancer, an adult fae knight whose armor has grown from hedge, bark, and silver, wearing nature-integrated plate with leaf edges, a long pale cloak, thorn crown under a helm circlet, and a pale gold torc; standing in a ready guard with the weapon held diagonally through the visible band; chivalric, reserved, and wholly committed to a vow that predates the visitor; against a moonlit knoll above a misty court-road, oak roots twisting through old stone; pearl moon key on the armor planes; saturated green rim along cloak and shield; reserve the entire top third as clear, empty moonlit mist or sky above the head, thorn crown, and antlers so no crown clips; no readable ogham, runes, letters, banners, cards, mirrors, or text anywhere — crisp cel-shaded gacha anime splash art, fully rendered scenic background, 640×800 portrait

### Fomorian Raider — `cf-fomorian-raider`
- **Card facts:** {2}{R}{R} · R · 5/3 · overrun · r · holo: shiny
- **Character & source:** an adult Fomorian raider, immense and glamorous in a brutal Otherworld way; mechanically an aggressive hunt leader.
- **Personality / mood:** “It raids because it is hungry. It is hungry because it raids.” — hungry, magnificent, and barely interested in restraint.
- **Pose & composition:** driving forward from a low angle, one shoulder and weapon breaking through a curtain of rain; face ≈ y 320 and eye-line ≈ y 300–360. The entire top third stays clear empty sky or mist above the head, crown, antlers, and hair for crop-safe headroom.
- **Costume & attire:** heavy bog-iron plates tangled with blackthorn, a jagged crown, raven feathers, and battered pale-gold rings.
- **Palette:** R palette (`#d95436` → `#5e0f0f`, accent `#f7b267`) — foxfire ember, blood-red, and warm peat; Celtic Fae accents — silver moonlight, moss green, blackthorn, raven black, glassy water, and pale gold torcs — layer over the color anchor without replacing it.
- **Lighting:** red storm-fire key from the left; silver lightning rim along the weapon and crown.
- **Expression:** hungry, magnificent, and barely interested in restraint.
- **Props / weapon:** a cleaver-like stone blade and a broken, wordless shield of cold iron.
...
- **Costume & attire:** a tiny silver torc, moss-green ribbon charms, and a wet blackthorn-leaf mantle.
- **Palette:** G palette (`#4fa06a` → `#123a22`, accent `#a9dcae`) — moss green, wet leaf shadow, and luminous verdigris; Celtic Fae accents — silver moonlight, moss green, blackthorn, raven black, glassy water, and pale gold torcs — layer over the color anchor without replacing it.
- **Lighting:** water reflection as a blue-green key; crisp silver moon rim around the wet silhouette.
- **Expression:** mischievous, exacting, and visibly calculating the price of a shortcut.
- **Props / weapon:** a polished river stone, reed wand, and a luminous fish-scale glint.
- **Background:** a shallow moon pool under willow roots, with a blurred fae court across the water.
- **Holo interaction:** Rolled specials favor shiny; concentrate reflective texture in silver torcs, dew, wet leaves, and thorn-metal while the face remains calm.
- **Rarity ambition:** Uncommon — a decisive courtly action plus one environmental story beat, without losing the silhouette at battlefield scale.
- **Prompt:** Otter Familiar, a sleek adult fae otter familiar, clever and courtly rather than cartoonish, wearing a tiny silver torc, moss-green ribbon charms, and a wet blackthorn-leaf mantle; upright on a river rock with forepaws poised over the stone, face centered and alert; mischievous, exacting, and visibly calculating the price of a shortcut; against a shallow moon pool under willow roots, with a blurred fae court across the water; water reflection as a blue-green key; crisp silver moon rim around the wet silhouette; reserve the entire top third as clear, empty moonlit mist or sky above the head, thorn crown, and antlers so no crown clips; no readable ogham, runes, letters, banners, cards, mirrors, or text anywhere — crisp cel-shaded gacha anime splash art, fully rendered scenic background, 640×800 portrait

### Crowbone Prophet — `cf-crowbone-prophet`
- **Card facts:** {2}{B} · B · 2/3 · r · holo: shiny
- **Character & source:** an adult crowbone prophet, a fae death oracle dressed for court rather than a cottage; mechanically a reader and arranger of fate, an intimate worker of grave memories.
- **Personality / mood:** “She reads the bones. You supply the margin notes.” — intimate, dryly amused, and unafraid of the answer.
- **Pose & composition:** kneeling upright at the cairn, one hand releasing bones into the bowl while her eyes meet the viewer; face ≈ y 320 and eye-line ≈ y 300–360. The entire top third stays clear empty sky or mist above the head, crown, antlers, and hair for crop-safe headroom.
- **Costume & attire:** a long black-violet cloak, thorn crown, silver jewelry, and layered bone-and-bark armor.
- **Palette:** B palette (`#5a3a70` → `#140d1c`, accent `#9b6fc4`) — blackthorn violet, raven-black, and grave-lilac; Celtic Fae accents — silver moonlight, moss green, blackthorn, raven black, glassy water, and pale gold torcs — layer over the color anchor without replacing it.
- **Lighting:** cold lantern key over the hands; moon-silver rim separating black cloak from the bog.
- **Expression:** intimate, dryly amused, and unafraid of the answer.
- **Props / weapon:** a bowl of smooth crow bones without markings, a black feather, and a pale gold knife.
...
- **Costume & attire:** a moss-green elongated hooded cloak, leaf-scale armor, thorn circlet, and silver fastenings.
- **Palette:** G palette (`#4fa06a` → `#123a22`, accent `#a9dcae`) — moss green, wet leaf shadow, and luminous verdigris; Celtic Fae accents — silver moonlight, moss green, blackthorn, raven black, glassy water, and pale gold torcs — layer over the color anchor without replacing it.
- **Lighting:** silver moon key across the face and bow; green bioluminescent rim from the thornmaze.
- **Expression:** quietly territorial, patient, and pleased that the hedge has chosen a side.
- **Props / weapon:** a yew bow, pale-gold arrowheads, and a compact blackthorn lantern.
- **Background:** a thornmaze tunnel opening onto a silver-lit mushroom ring.
- **Holo interaction:** Rolled specials favor shiny; concentrate reflective texture in silver torcs, dew, wet leaves, and thorn-metal while the face remains calm.
- **Rarity ambition:** Uncommon — a decisive courtly action plus one environmental story beat, without losing the silhouette at battlefield scale.
- **Prompt:** Thornmaze Patrol, an adult fae ranger who knows every hedge as a court corridor, wearing a moss-green elongated hooded cloak, leaf-scale armor, thorn circlet, and silver fastenings; camera pulled back to a true waist-up view — her body from head to waist fully in frame and her face reading smaller in the composition, drawing the bow sideways across the frame, body turned but moonlit eyes fixed on the viewer; quietly territorial, patient, and pleased that the hedge has chosen a side; against a thornmaze tunnel opening onto a silver-lit mushroom ring; silver moon key across the face and bow; green bioluminescent rim from the thornmaze; the very top of her head, hood, and circlet sits clearly below the top-third line — the entire top third is nothing but clear empty moonlit mist, generous open space above the head so nothing clips; no readable ogham, runes, letters, banners, cards, mirrors, or text anywhere — crisp cel-shaded gacha anime splash art, fully rendered scenic background, 640×800 portrait

### Bog-Lantern Witch — `cf-bog-lantern-witch`
- **Card facts:** {2}{B}{B} · B · 2/3 · deathblade · r · holo: shiny
- **Character & source:** an adult bog witch of the fae court, regal and terrifyingly hospitable; mechanically lethal at a single precise touch, a keeper of the veil between worlds.
- **Personality / mood:** “Follow her lantern. It always leads somewhere, just never home.” — inviting, unsmiling, and entirely aware that the safe road ends elsewhere.
- **Pose & composition:** waist-up at the waterline, lantern held low to light the central face and knife hand; face ≈ y 320 and eye-line ≈ y 300–360. The entire top third stays clear empty sky or mist above the head, crown, antlers, and hair for crop-safe headroom.
- **Costume & attire:** a layered blackthorn cloak, a silver torc, a thorn crown, and fitted bark armor under wet moss shawls.
- **Palette:** B palette (`#5a3a70` → `#140d1c`, accent `#9b6fc4`) — blackthorn violet, raven-black, and grave-lilac; Celtic Fae accents — silver moonlight, moss green, blackthorn, raven black, glassy water, and pale gold torcs — layer over the color anchor without replacing it.
- **Lighting:** lantern-green key from below-left; sharp silver moon rim across the crown and cloak.
- **Expression:** inviting, unsmiling, and entirely aware that the safe road ends elsewhere.
- **Props / weapon:** a bog lantern, a slim thorn knife, and a cauldron charm without any readable marks.
- **Background:** a reed-choked bog with a single glassy pool, cairns, and distant mushroom-ring lights.
- **Holo interaction:** Rolled specials favor shiny; concentrate reflective texture in silver torcs, dew, wet leaves, and thorn-metal while the face remains calm.
- **Rarity ambition:** Uncommon — a decisive courtly action plus one environmental story beat, without losing the silhouette at battlefield scale.
- **Prompt:** Bog-Lantern Witch, an adult bog witch of the fae court, regal and terrifyingly hospitable, wearing a layered blackthorn cloak, a silver torc, a thorn crown, and fitted bark armor under wet moss shawls; waist-up at the waterline, lantern held low to light the central face and knife hand; inviting, unsmiling, and entirely aware that the safe road ends elsewhere; against a reed-choked bog with a single glassy pool, cairns, and distant mushroom-ring lights; lantern-green key from below-left; sharp silver moon rim across the crown and cloak; reserve the entire top third as clear, empty moonlit mist or sky above the head, thorn crown, and antlers so no crown clips; no readable ogham, runes, letters, banners, cards, mirrors, or text anywhere — crisp cel-shaded gacha anime splash art, fully rendered scenic background, 640×800 portrait

### Green Knoll Champion — `cf-green-knoll-champion`
- **Card facts:** {2}{G}{G} · G · 4/4 · sentinel, overrun · r · holo: shiny
- **Character & source:** an adult fae knight whose armor has grown from hedge, bark, and silver; mechanically a steadfast boundary keeper, an aggressive hunt leader.
- **Personality / mood:** “She guards the hill because the hill once chose her.” — chivalric, reserved, and wholly committed to a vow that predates the visitor.
- **Pose & composition:** standing in a ready guard with the weapon held diagonally through the visible band; face ≈ y 320 and eye-line ≈ y 300–360. The entire top third stays clear empty sky or mist above the head, crown, antlers, and hair for crop-safe headroom.
- **Costume & attire:** nature-integrated plate with leaf edges, a long pale cloak, thorn crown under a helm circlet, and a pale gold torc.
- **Palette:** G palette (`#4fa06a` → `#123a22`, accent `#a9dcae`) — moss green, wet leaf shadow, and luminous verdigris; Celtic Fae accents — silver moonlight, moss green, blackthorn, raven black, glassy water, and pale gold torcs — layer over the color anchor without replacing it.
- **Lighting:** pearl moon key on the armor planes; saturated green rim along cloak and shield.
...
- **Costume & attire:** a simple elongated blue cloak, small thorn circlet, silver earrings, and leaf-shaped shoulder guards.
- **Palette:** U palette (`#4a90d9` → `#16294f`, accent `#a8d4f7`) — deep pool-blue, silver mist, and cold moonlight; Celtic Fae accents — silver moonlight, moss green, blackthorn, raven black, glassy water, and pale gold torcs — layer over the color anchor without replacing it.
- **Lighting:** soft pool-blue moon key; green mushroom-light rim on the cloak hem and hair.
- **Expression:** eager, cautious, and beginning to understand the price of being welcomed.
- **Props / weapon:** a clear scrying bowl and a modest hazel wand, both deliberately free of text.
- **Background:** a small mushroom ring in dewy grass beneath a hollow-hill glow.
- **Holo interaction:** No signature holo; keep the face and central silhouette clean so the moonlit value read survives at small scale.
- **Rarity ambition:** Common — one poised figure and one instantly readable fae gesture; keep the scenic background to two dominant values.
- **Prompt:** Fae-Ring Initiate, an adult fae-ring initiate at the first threshold of a dangerous education, wearing a simple elongated blue cloak, small thorn circlet, silver earrings, and leaf-shaped shoulder guards; standing inside the ring with the bowl held just below the face, chin lifted in resolve; eager, cautious, and beginning to understand the price of being welcomed; against a small mushroom ring in dewy grass beneath a hollow-hill glow; soft pool-blue moon key; green mushroom-light rim on the cloak hem and hair; reserve the entire top third as clear, empty moonlit mist or sky above the head, thorn crown, and antlers so no crown clips; no readable ogham, runes, letters, banners, cards, mirrors, or text anywhere — crisp cel-shaded gacha anime splash art, fully rendered scenic background, 640×800 portrait

### Mistwing Pixie — `cf-mistwing-pixie`
- **Card facts:** {1}{U} · U · 2/1 · skyborne · c · holo: none
- **Character & source:** an adult pixie court scout, petite but clearly adult-coded and battle-ready; mechanically an airborne omen and evasive threat.
- **Personality / mood:** “She leaves fingerprints on the fog just to prove she was there.” — playful, sharp-eyed, and just out of reach.
- **Pose & composition:** hovering upright at a three-quarter angle, wings framing rather than hiding the centered face; face ≈ y 320 and eye-line ≈ y 300–360. The entire top third stays clear empty sky or mist above the head, crown, antlers, and hair for crop-safe headroom.
- **Costume & attire:** a silver-edged mist cloak, thorn circlet, fitted leaf armor, and fine jewelry that catches the moon.
- **Palette:** U palette (`#4a90d9` → `#16294f`, accent `#a8d4f7`) — deep pool-blue, silver mist, and cold moonlight; Celtic Fae accents — silver moonlight, moss green, blackthorn, raven black, glassy water, and pale gold torcs — layer over the color anchor without replacing it.
- **Lighting:** cool moon key through the wings; lavender fog rim around cloak and ankles.
- **Expression:** playful, sharp-eyed, and just out of reach.
- **Props / weapon:** translucent insect wings, a tiny silver dagger, and drifting glimmerdust.
- **Background:** high fog above a blackthorn copse, with distant hollow hills reduced to soft shapes.
- **Holo interaction:** No signature holo; keep the face and central silhouette clean so the moonlit value read survives at small scale.
- **Rarity ambition:** Common — one poised figure and one instantly readable fae gesture; keep the scenic background to two dominant values.
- **Prompt:** Mistwing Pixie, an adult pixie court scout, petite but clearly adult-coded and battle-ready, wearing a silver-edged mist cloak, thorn circlet, fitted leaf armor, and fine jewelry that catches the moon; hovering upright at a three-quarter angle, wings framing rather than hiding the centered face; playful, sharp-eyed, and just out of reach; against high fog above a blackthorn copse, with distant hollow hills reduced to soft shapes; cool moon key through the wings; lavender fog rim around cloak and ankles; reserve the entire top third as clear, empty moonlit mist or sky above the head, thorn crown, and antlers so no crown clips; no readable ogham, runes, letters, banners, cards, mirrors, or text anywhere — crisp cel-shaded gacha anime splash art, fully rendered scenic background, 640×800 portrait

### Thorn Sprite — `cf-thorn-sprite`
- **Card facts:** {G} · G · 1/2 · wardingGaze · c · holo: none
- **Character & source:** an adult thorn sprite, small in scale but regal in stance; mechanically a poised, immediate presence on the battlefield.
- **Personality / mood:** “Small enough to miss. Sharp enough to regret.” — alert, proud, and one bad step away from delighted retaliation.
- **Pose & composition:** balanced on a thorn branch with the rapier held forward, face fully visible in the center band; face ≈ y 320 and eye-line ≈ y 300–360. The entire top third stays clear empty sky or mist above the head, crown, antlers, and hair for crop-safe headroom.
- **Costume & attire:** a blackthorn-petal cloak, slim green armor grown from leaves, a tiny thorn crown, and silver ear cuffs.
- **Palette:** G palette (`#4fa06a` → `#123a22`, accent `#a9dcae`) — moss green, wet leaf shadow, and luminous verdigris; Celtic Fae accents — silver moonlight, moss green, blackthorn, raven black, glassy water, and pale gold torcs — layer over the color anchor without replacing it.
- **Lighting:** cold moon key on the cheek and blade; acid-green leaf rim along the small silhouette.
- **Expression:** alert, proud, and one bad step away from delighted retaliation.
- **Props / weapon:** a thorn rapier, seed-lantern, and sharp leaf wings.
- **Background:** a close blackthorn hedge opening onto a moonlit clearing, rendered with deep readable depth.
- **Holo interaction:** No signature holo; keep the face and central silhouette clean so the moonlit value read survives at small scale.
- **Rarity ambition:** Common — one poised figure and one instantly readable fae gesture; keep the scenic background to two dominant values.
- **Prompt:** Thorn Sprite, an adult thorn sprite, small in scale but regal in stance, wearing a blackthorn-petal cloak, slim green armor grown from leaves, a tiny thorn crown, and silver ear cuffs; balanced on a thorn branch with the rapier held forward, face fully visible in the center band; alert, proud, and one bad step away from delighted retaliation; against a close blackthorn hedge opening onto a moonlit clearing, rendered with deep readable depth; cold moon key on the cheek and blade; acid-green leaf rim along the small silhouette; the very top of her head, crown, and wingtips sits clearly below the top-third line — the entire top third is nothing but clear empty moonlit mist, generous open space above the head so nothing clips; no readable ogham, runes, letters, banners, cards, mirrors, or text anywhere — crisp cel-shaded gacha anime splash art, fully rendered scenic background, 640×800 portrait

### Redcap Skirmisher — `cf-redcap-skirmisher`
- **Card facts:** {1}{R} · R · 3/1 · warcry · c · holo: none
- **Character & source:** an adult redcap skirmisher, compact, regal, and very pleased with the violence; mechanically an aggressive hunt leader.
- **Personality / mood:** “She starts the fight early so the rules cannot catch up.” — reckless, courtly in the worst possible way, and laughing through clenched teeth.
- **Pose & composition:** caught at the first violent step of a sprint, sickle low and shoulders driving forward; face ≈ y 320 and eye-line ≈ y 300–360. The entire top third stays clear empty sky or mist above the head, crown, antlers, and hair for crop-safe headroom.
- **Costume & attire:** a crimson cap over a thorn crownlet, short blackthorn cloak, layered peat-black armor, and silver rings.
- **Palette:** R palette (`#d95436` → `#5e0f0f`, accent `#f7b267`) — foxfire ember, blood-red, and warm peat; Celtic Fae accents — silver moonlight, moss green, blackthorn, raven black, glassy water, and pale gold torcs — layer over the color anchor without replacing it.
- **Lighting:** warm foxfire key across the cap and weapon; hard violet moon rim on the moving silhouette.
...
- **Holo interaction:** No signature holo; keep the face and central silhouette clean so the moonlit value read survives at small scale.
- **Rarity ambition:** Common — one poised figure and one instantly readable fae gesture; keep the scenic background to two dominant values.
- **Prompt:** Bog Banshee, an adult banshee of the old courts, beautiful and ruinously composed, wearing a torn but regal mist-grey mourning cloak, thorn-silver hair ornaments, and nature-etched black armor at the shoulders; seen from further back so her whole ghostly spectral form floats fully in frame, one hand near her throat, cloak and hair rising in the note she has not yet released; funereal, intimate, and mercilessly patient; against a bog-side cairn field with low mist, raven feathers, and one distant hollow-hill light; lilac bog-glow as key from below; sharp moon-silver rim around the veiling hair; the very top of her head and rising hair sits clearly below the top-third line — the entire top third is nothing but clear empty moonlit mist, generous open space above the head so nothing clips; no readable ogham, runes, letters, banners, cards, mirrors, or text anywhere — crisp cel-shaded gacha anime splash art, fully rendered scenic background, 640×800 portrait

### Sidhe Page — `cf-sidhe-page`
- **Card facts:** {1}{W} · W · 1/3 · sentinel · c · holo: none
- **Character & source:** an adult Sidhe blade dancer of the silver court; mechanically a steadfast boundary keeper.
- **Personality / mood:** “A page learns every courtly bow before learning where the exits are.” — precise, proud, and too polite to call the first strike a threat.
- **Pose & composition:** three-quarter lunge, blade leading across the middle band while the cloak counter-sweeps behind; face ≈ y 320 and eye-line ≈ y 300–360. The entire top third stays clear empty sky or mist above the head, crown, antlers, and hair for crop-safe headroom.
- **Costume & attire:** a close-fitted green-black dueling coat under an elongated split cloak, thorn crown, silver jewelry, and leaf-steel vambraces.
- **Palette:** W palette (`#f2e8cf` → `#c9a84c`, accent `#fffef2`) — pearl-white, pale gold, and moonlit ivory; Celtic Fae accents — silver moonlight, moss green, blackthorn, raven black, glassy water, and pale gold torcs — layer over the color anchor without replacing it.
- **Lighting:** clean moon-silver key on the blade side; lush moss-green rim along cloak and boots.
...
- **Holo interaction:** No signature holo; keep the face and central silhouette clean so the moonlit value read survives at small scale.
- **Rarity ambition:** Common — one poised figure and one instantly readable fae gesture; keep the scenic background to two dominant values.
- **Prompt:** Omen Raven, an adult raven-aspected fae envoy, not a childlike bird mascot, wearing a feathered black cloak over slim court armor, a thorn tiara, silver rings, and a pale gold raven torc; landing or stepping from a low rock with the cloak opening like folded wings; watchful, formal, and carrying news nobody will enjoy; against a cairn-lined moor with a murder of ravens circling through silver fog; overcast moon key across the face; violet-black feather rim from the fog behind; reserve the entire top third as clear, empty moonlit mist or sky above the head, thorn crown, and antlers so no crown clips; no readable ogham, runes, letters, banners, cards, mirrors, or text anywhere — crisp cel-shaded gacha anime splash art, fully rendered scenic background, 640×800 portrait

### Selkie Runner — `cf-selkie-runner`
- **Card facts:** {1}{U} · U · 2/1 · c · holo: none
- **Character & source:** an adult selkie courtier, elegant in both sea and shore forms; mechanically a reader and arranger of fate.
- **Personality / mood:** “She brings messages across the tide, usually to the wrong shore.” — unhurried, elusive, and delighted to know more than she says.
- **Pose & composition:** rising from the pool at a three-quarter turn, one hand skimming water into a bright arc; face ≈ y 320 and eye-line ≈ y 300–360. The entire top third stays clear empty sky or mist above the head, crown, antlers, and hair for crop-safe headroom.
- **Costume & attire:** a seal-skin mantle worn over a fitted teal-and-silver court gown, shell clasps, a fine torc, and wet moonlit hair.
- **Palette:** U palette (`#4a90d9` → `#16294f`, accent `#a8d4f7`) — deep pool-blue, silver mist, and cold moonlight; Celtic Fae accents — silver moonlight, moss green, blackthorn, raven black, glassy water, and pale gold torcs — layer over the color anchor without replacing it.
- **Lighting:** moon reflection on the water as a blue-silver key; deep green sea-glow as the rim.
...
- **Holo interaction:** No signature holo; keep the face and central silhouette clean so the moonlit value read survives at small scale.
- **Rarity ambition:** Common — one poised figure and one instantly readable fae gesture; keep the scenic background to two dominant values.
- **Prompt:** Selkie Runner, an adult selkie courtier, elegant in both sea and shore forms, wearing a seal-skin mantle worn over a fitted teal-and-silver court gown, shell clasps, a fine torc, and wet moonlit hair; rising from the pool at a three-quarter turn, one hand skimming water into a bright arc; unhurried, elusive, and delighted to know more than she says; against a black-glass tidal pool ringed by kelp, moonlit rocks, and a distant hollow-hill door; moon reflection on the water as a blue-silver key; deep green sea-glow as the rim; the very top of her head and wet hair sits clearly below the top-third line — the entire top third is nothing but clear empty moonlit mist and night sky, generous open space above the head so nothing clips; no readable ogham, runes, letters, banners, cards, mirrors, or text anywhere — crisp cel-shaded gacha anime splash art, fully rendered scenic background, 640×800 portrait

### Mushroom-Ring Guard — `cf-mushroom-ring-guard`
- **Card facts:** {1}{G} · G · 1/4 · bulwark · c · holo: none
- **Character & source:** an adult fae ring guard, a formal protector of the boundary between invitation and trap; mechanically a steadfast boundary keeper.
- **Personality / mood:** “Step inside the ring. Please. We insist.” — patient, ceremonious, and impossible to embarrass into moving.
- **Pose & composition:** squarely braced at the ring entrance, staff angled toward the ground and shoulders immovable; face ≈ y 320 and eye-line ≈ y 300–360. The entire top third stays clear empty sky or mist above the head, crown, antlers, and hair for crop-safe headroom.
- **Costume & attire:** mushroom-cap-inspired pauldrons, a long moss cloak, thorn crown, silver bracelets, and bark armor.
- **Palette:** G palette (`#4fa06a` → `#123a22`, accent `#a9dcae`) — moss green, wet leaf shadow, and luminous verdigris; Celtic Fae accents — silver moonlight, moss green, blackthorn, raven black, glassy water, and pale gold torcs — layer over the color anchor without replacing it.
- **Lighting:** pale mushroom-light key from the front; deep moss-green rim against the night.
- **Expression:** patient, ceremonious, and impossible to embarrass into moving.
- **Props / weapon:** a broad staff topped with a blank silver disk and a root-woven shield.
...
- **Costume & attire:** a gauzy elongated cloak of silver mist, a delicate thorn circlet, and faint leaf-metal bracers.
- **Palette:** G palette (`#4fa06a` → `#123a22`, accent `#a9dcae`) — moss green, wet leaf shadow, and luminous verdigris; Celtic Fae accents — silver moonlight, moss green, blackthorn, raven black, glassy water, and pale gold torcs — layer over the color anchor without replacing it.
- **Lighting:** blue-white wisp key on the face; green fog rim dissolving the cloak edges.
- **Expression:** helpful in the manner of someone who knows a more interesting route.
- **Props / weapon:** a floating wisp lantern, willow switch, and tiny pale-gold charms.
- **Background:** a willow-fringed marsh road disappearing into moonlit fog.
- **Holo interaction:** No signature holo; keep the face and central silhouette clean so the moonlit value read survives at small scale.
- **Rarity ambition:** Common — one poised figure and one instantly readable fae gesture; keep the scenic background to two dominant values.
- **Prompt:** Willow-Wisp Guide, an adult willow-wisp guide, a luminous fae apparition with a courtly silhouette, wearing a gauzy elongated cloak of silver mist, a delicate thorn circlet, and faint leaf-metal bracers; gliding forward with the lantern held in front of the torso, face calm and directly readable; helpful in the manner of someone who knows a more interesting route; against a willow-fringed marsh road disappearing into moonlit fog; blue-white wisp key on the face; green fog rim dissolving the cloak edges; reserve the entire top third as clear, empty moonlit mist or sky above the head, thorn crown, and antlers so no crown clips; no readable ogham, runes, letters, banners, cards, mirrors, or text anywhere — crisp cel-shaded gacha anime splash art, fully rendered scenic background, 640×800 portrait

### Fae Court Reveler — `cf-fae-court-tokenmaker`
- **Card facts:** {2}{G} · G · 2/3 · c · holo: none
- **Character & source:** an adult fae court reveler who treats celebration as summoning magic; mechanically a caller of courtly bloom spirits.
- **Personality / mood:** “One dance summons a guest. Two dances summon a season.” — joyous, commanding, and reckless only if you mistake the invitation for freedom.
- **Pose & composition:** mid-turn with one hand raised, cloak orbiting around a face held steady in the central band; face ≈ y 320 and eye-line ≈ y 300–360. The entire top third stays clear empty sky or mist above the head, crown, antlers, and hair for crop-safe headroom.
- **Costume & attire:** a flowing moss-green cloak, thorn crown, moon-silver jewelry, and petal-and-bark dance armor.
- **Palette:** G palette (`#4fa06a` → `#123a22`, accent `#a9dcae`) — moss green, wet leaf shadow, and luminous verdigris; Celtic Fae accents — silver moonlight, moss green, blackthorn, raven black, glassy water, and pale gold torcs — layer over the color anchor without replacing it.
- **Lighting:** pale gold dance-fire key; cold silver moon rim along the spinning cloak.
- **Expression:** joyous, commanding, and reckless only if you mistake the invitation for freedom.
- **Props / weapon:** a silver cup, flower motes, and a slender branch ribbon with no lettering.
- **Background:** a moonlit dance beneath the mound, with mushroom rings and soft figures kept secondary.
- **Holo interaction:** No signature holo; keep the face and central silhouette clean so the moonlit value read survives at small scale.
- **Rarity ambition:** Common — one poised figure and one instantly readable fae gesture; keep the scenic background to two dominant values.
- **Prompt:** Fae Court Reveler, an adult fae court reveler who treats celebration as summoning magic, wearing a flowing moss-green cloak, thorn crown, moon-silver jewelry, and petal-and-bark dance armor; camera pulled back to a wider view, mid-turn with one hand raised, cloak orbiting around a face held steady in the central band; joyous, commanding, and reckless only if you mistake the invitation for freedom; against a moonlit fae revel whirling around her beneath the mound — dancing courtiers, drifting lanterns, laden feast boards, and glowing mushroom rings; pale gold dance-fire key; cold silver moon rim along the spinning cloak; the very top of her head and thorn crown sits clearly below the top-third line — the entire top third is nothing but clear empty moonlit mist, generous open space above the crown so nothing clips; no readable ogham, runes, letters, banners, cards, mirrors, or text anywhere — crisp cel-shaded gacha anime splash art, fully rendered scenic background, 640×800 portrait

### Cold-Moon Archer — `cf-cold-moon-archer`
- **Card facts:** {1}{W} · W · 1/3 · wardingGaze · c · holo: none
- **Character & source:** an adult cold-moon fae archer, serene behind a lethal draw; mechanically a poised, immediate presence on the battlefield.
- **Personality / mood:** “Her arrows return at moonrise. Their targets do not.” — still, courtly, and already certain of the shot.
- **Pose & composition:** waist-up in a controlled full draw, bow curving around the face without crossing it; face ≈ y 320 and eye-line ≈ y 300–360. The entire top third stays clear empty sky or mist above the head, crown, antlers, and hair for crop-safe headroom.
- **Costume & attire:** a white-silver cloak, thorn tiara, leaf-steel cuirass, and pale gold arm rings.
- **Palette:** W palette (`#f2e8cf` → `#c9a84c`, accent `#fffef2`) — pearl-white, pale gold, and moonlit ivory; Celtic Fae accents — silver moonlight, moss green, blackthorn, raven black, glassy water, and pale gold torcs — layer over the color anchor without replacing it.
- **Lighting:** cold moon key on face and arrowhead; blue-green rim from the low mist.
- **Expression:** still, courtly, and already certain of the shot.
- **Props / weapon:** a crescent yew bow, a silver apple-arrow, and a patterned but textless quiver.
...
- **Costume & attire:** a heather-purple cloak over green leaf armor, a small thorn crown, silver rings, and travel-worn boots.
- **Palette:** G palette (`#4fa06a` → `#123a22`, accent `#a9dcae`) — moss green, wet leaf shadow, and luminous verdigris; Celtic Fae accents — silver moonlight, moss green, blackthorn, raven black, glassy water, and pale gold torcs — layer over the color anchor without replacing it.
- **Lighting:** cool moon key over the ridge wind; warm foxfire rim on the moving cloak edge.
- **Expression:** quick, observant, and pleased to have found the better route first.
- **Props / weapon:** a short heatherblade, folded map skin with no markings, and a raven feather clasp.
- **Background:** wind-bent heather above a misty valley, a hollow hill distant under the moon.
- **Holo interaction:** No signature holo; keep the face and central silhouette clean so the moonlit value read survives at small scale.
- **Rarity ambition:** Common — one poised figure and one instantly readable fae gesture; keep the scenic background to two dominant values.
- **Prompt:** Heatherblade Scout, an adult highland fae scout, swift and sharply self-possessed, wearing a heather-purple cloak over green leaf armor, a small thorn crown, silver rings, and travel-worn boots; running across a ridge in a three-quarter turn, blade low and face turned back toward the viewer; quick, observant, and pleased to have found the better route first; against wind-bent heather above a misty valley, a hollow hill distant under the moon; cool moon key over the ridge wind; warm foxfire rim on the moving cloak edge; the very top of her head and small crown sits clearly below the top-third line — the entire top third is nothing but clear empty moonlit sky, generous open space above the head so nothing clips; no readable ogham, runes, letters, banners, cards, mirrors, or text anywhere — crisp cel-shaded gacha anime splash art, fully rendered scenic background, 640×800 portrait

### Torclight Envoy — `cf-torclight-envoy`
- **Card facts:** {1}{W} · W · 2/2 · c · holo: none
- **Character & source:** an adult fae diplomat whose hospitality is a precise form of power; mechanically a poised, immediate presence on the battlefield.
- **Personality / mood:** “Her torch lights the path and counts everyone who takes it.” — kindly, measuring, and impossible to read as harmless.
- **Pose & composition:** front three-quarter, camera pulled back slightly to a true waist-up view with her whole torso in frame, lantern held just below the face while the other hand offers passage; face ≈ y 320 and eye-line ≈ y 300–360. The entire top third stays clear empty sky or mist above the head, crown, antlers, and hair for crop-safe headroom.
- **Costume & attire:** a pearl-white elongated cloak, restrained thorn crown, silver jewelry, and smooth oak-leaf armor.
- **Palette:** W palette (`#f2e8cf` → `#c9a84c`, accent `#fffef2`) — pearl-white, pale gold, and moonlit ivory; Celtic Fae accents — silver moonlight, moss green, blackthorn, raven black, glassy water, and pale gold torcs — layer over the color anchor without replacing it.
- **Lighting:** warm torc-lantern key across the hands; clean silver moon rim on the cloak.
- **Expression:** kindly, measuring, and impossible to read as harmless.
- **Props / weapon:** a small torc-lantern, an open empty hand, and a sealed-looking but unlettered silver token.
...
- **Costume & attire:** a short ember-red cloak, thorn crown, silver earrings, and flexible leaf-and-leather armor.
- **Palette:** R palette (`#d95436` → `#5e0f0f`, accent `#f7b267`) — foxfire ember, blood-red, and warm peat; Celtic Fae accents — silver moonlight, moss green, blackthorn, raven black, glassy water, and pale gold torcs — layer over the color anchor without replacing it.
- **Lighting:** foxfire key warming the grin; silver moon rim splitting the transformation shadows.
- **Expression:** laughing, insolent, and visibly one step ahead of the explanation.
- **Props / weapon:** a silver bridle charm, a foxfire lantern, and a curved switch.
...
- **Costume & attire:** a moss-green cloak, mature thorn crown, silver torc, and leaf-scale armor with rootlike seams.
- **Palette:** G palette (`#4fa06a` → `#123a22`, accent `#a9dcae`) — moss green, wet leaf shadow, and luminous verdigris; Celtic Fae accents — silver moonlight, moss green, blackthorn, raven black, glassy water, and pale gold torcs — layer over the color anchor without replacing it.
- **Lighting:** spring reflection as a green-blue key; silver moon rim on crown, wand, and shoulder.
- **Expression:** grounded, wry, and more interested in the roots than the visitor.
- **Props / weapon:** a forked hazel wand, a bowl of clear water, and a cluster of bright nuts.
...
- **Costume & attire:** a weathered white cloak, thorn circlet, silver jewelry, and low-profile bark armor under the fabric.
- **Palette:** W palette (`#f2e8cf` → `#c9a84c`, accent `#fffef2`) — pearl-white, pale gold, and moonlit ivory; Celtic Fae accents — silver moonlight, moss green, blackthorn, raven black, glassy water, and pale gold torcs — layer over the color anchor without replacing it.
- **Lighting:** soft lantern key at chest height; cool moon rim tracing the cloak and staff.
- **Expression:** professional, patient, and subtly amused by anyone who thinks the path is free.
- **Props / weapon:** a crook-staff, a small silver lantern, and a braided blackthorn charm.
...
- **Costume & attire:** mossy fur, a pale gold antler torque, silver leaf charms, and blackthorn vines braided through its antlers.
- **Palette:** G palette (`#4fa06a` → `#123a22`, accent `#a9dcae`) — moss green, wet leaf shadow, and luminous verdigris; Celtic Fae accents — silver moonlight, moss green, blackthorn, raven black, glassy water, and pale gold torcs — layer over the color anchor without replacing it.
- **Lighting:** silver moon key down the face and antlers; green pool-light rim through the fur.
- **Expression:** watchful, solemn, and gently warning the viewer not to follow.
- **Props / weapon:** branching antlers bearing one raven feather and a faint trail of drifting motes.
- **Background:** a silver-green grove with a glassy pool and mushroom ring blurred behind the antler silhouette.
- **Holo interaction:** No signature holo; keep the face and central silhouette clean so the moonlit value read survives at small scale.
- **Rarity ambition:** Common — one poised figure and one instantly readable fae gesture; keep the scenic background to two dominant values.
- **Prompt:** Veil-Touched Hart, a sacred Otherworld hart, statuesque and ancient rather than cute, with luminous moonlit eyes, wearing mossy fur, a pale gold antler torque, silver leaf charms, and blackthorn vines braided through its antlers; standing three-quarter with the head lifted, eyes and antlers completely clear in the middle band; watchful, solemn, and gently warning the viewer not to follow; against a silver-green grove with a glassy pool and mushroom ring blurred behind the antler silhouette; silver moon key down the face and antlers; green pool-light rim through the fur; reserve the entire top third as clear, empty moonlit mist or sky above the head, thorn crown, and antlers so no crown clips; no readable ogham, runes, letters, banners, cards, mirrors, or text anywhere — crisp cel-shaded gacha anime splash art, fully rendered scenic background, 640×800 portrait

### Cairnlight Adept — `cf-cairnlight-adept`
- **Card facts:** {1}{B} · B · 2/2 · c · holo: none
- **Character & source:** an adult bog witch of the fae court, regal and terrifyingly hospitable; mechanically an intimate worker of grave memories.
- **Personality / mood:** “She tends the grave-lights. They tend her secrets.” — inviting, unsmiling, and entirely aware that the safe road ends elsewhere.
- **Pose & composition:** camera pulled back to a wider view showing her body from head to hips, standing at the waterline, lantern held low to light the central face and knife hand; face ≈ y 320 and eye-line ≈ y 300–360. The entire top third stays clear empty sky or mist above the head, crown, antlers, and hair for crop-safe headroom.
- **Costume & attire:** a layered blackthorn cloak, a silver torc, a thorn crown, and fitted bark armor under wet moss shawls.
- **Palette:** B palette (`#5a3a70` → `#140d1c`, accent `#9b6fc4`) — blackthorn violet, raven-black, and grave-lilac; Celtic Fae accents — silver moonlight, moss green, blackthorn, raven black, glassy water, and pale gold torcs — layer over the color anchor without replacing it.
- **Lighting:** lantern-green key from below-left; sharp silver moon rim across the crown and cloak.
- **Expression:** inviting, unsmiling, and entirely aware that the safe road ends elsewhere.
...
- **Holo interaction:** No signature holo; keep the face and central silhouette clean so the moonlit value read survives at small scale.
- **Rarity ambition:** Common — one poised figure and one instantly readable fae gesture; keep the scenic background to two dominant values.
- **Prompt:** Cairnlight Adept, an adult bog witch of the fae court, regal and terrifyingly hospitable, wearing a layered blackthorn cloak, a silver torc, a thorn crown, and fitted bark armor under wet moss shawls; camera pulled back to a wider view showing her body from head to hips, her face reading smaller in the composition, standing at the waterline, lantern held low to light the central face and knife hand; inviting, unsmiling, and entirely aware that the safe road ends elsewhere; against a reed-choked bog with a single glassy pool, cairns, and distant mushroom-ring lights; lantern-green key from below-left; sharp silver moon rim across the crown and cloak; the very top of her head and thorn crown sits clearly below the top-third line — the entire top third is nothing but clear empty moonlit bog mist, generous open space above the crown so nothing clips; no readable ogham, runes, letters, banners, cards, mirrors, or text anywhere — crisp cel-shaded gacha anime splash art, fully rendered scenic background, 640×800 portrait
